...
watch_list:
  - episode_label: "Ep 1 · new host, new era"
    body: "The premiere establishes David Genat's presence behind the torch and introduces the season's new second-chance twist. Watch for how Genat's style — shaped by his own experience as a player — reads differently than LaPaglia's hosting register."
  - episode_label: "Redemption Beach · the twist in action"
    body: "Watch how the Redemption Beach mechanic reshapes the game's strategic calculus. When voted-out players can return, the target hierarchy changes — sending someone there is a different strategic act than simply eliminating them."
  - episode_label: "End game · Genat era opens"
    body: "The final episodes close the first chapter of Australian Survivor's Genat era. Watch how the season resolves both the elimination-twist thread and the central strategic story — the debut sets the tone for whatever follows."
---
