...
meth_who_p: "tiered.tv's editor. I've watched every aired season of Below Deck Mediterranean, from the Montenegro origin to the Adriatic return. The ranking weights cast chemistry, location quality, captain authority, and what each season added to the format — never outcomes, never who was fired last. One read, held with conviction and open to revision."
...
meth_when_p: "The canon expands as later seasons are seeded. Five slots reflect the founding run. The Captain Sandy return seasons and the Iain Sneddon transition will reshape the upper range as those entries land. The ranking stays honest: a season that improves on second watch moves up; one that deflates stays put."
tier_b_blurb: "Five founding seasons that established the Med spinoff's identity — from a rough Montenegrin origin to the Dubrovnik peak that showed what the format could become with the right cast and coast."
weekly_question: "Is the Dubrovnik season the best Below Deck entry across both franchises, or does the original's Sint Maarten run still hold the argument?"
era_bands:
  - key: sandy-founding
...
slot_argument: A reliable Below Deck Mediterranean season without a defining character. Mallorca and Ibiza gave the show beautiful western Med material; the cast delivered friction without a storyline that demanded full attention.
