...
host: "Carson Daly"
eyebrow: "Reba McEntire settles into the panel — Gwen Stefani returns"
lede: "Season twenty-five established Reba McEntire as the format's new anchor, returning alongside John Legend, Niall Horan, and Gwen Stefani. The panel was stable and experienced, with enough overlap from recent seasons to run smoothly if without the friction a debut generates."
pull: "The format finding its new footing — settled, competent, a degree below urgent."
format_summary: "Blind audition competition"
format_caption: "Reba McEntire's second season; returning panel with Gwen Stefani"
cast_size: 4
