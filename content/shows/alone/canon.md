...
last_revised: 2026-06-15
meth_who_h: "Who ranks it"
meth_who_p: "tiered.tv's editor. I've watched every season of the no-host era and tracked the format across its first five runs. The ranking weighs historical consequence, format shape, and what each season contributed to the show's identity — never outcomes, never who lasted longest. It is one read, held with confidence."
meth_how_h: "How I weigh it"
meth_how_p: "Format consequence comes first. The origin run, the first format departure, the first return-to-location, the pairs experiment, the all-returnees season — each earns its slot by what it added or proved. A structurally novel season earns credit for the risk. A cleaner second run earns credit for showing the format could sustain itself."
meth_when_h: "When I revisit"
meth_when_p: "The canon moves when new seasons air and settle. Each run in the no-host era has had years to find its reputation among the audience; these five slots reflect that settled view. Later seasons slot in on merit as they complete. I'm not claiming to be objective. I'm trying to be honest."
tier_b_blurb: "Five seasons establishing the format's range — origin run, first international location, first format experiment, first all-returnee field."
weekly_question: "Does the Patagonia run belong above the Vancouver Island origin, or does the original always hold the top?"
era_bands:
  - key: no-host-era
    label: "No-host era"
    range: [2015, 2019]
