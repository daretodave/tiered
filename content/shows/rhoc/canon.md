...
tier_c_blurb: "Seasons where the format runs below its capability — production constraints, cast mismatches, or transitional construction work visible in the output."
weekly_question: "Does season two hold the top canon spot, or does the debut's franchise-origin weight close the gap?"
era_bands:
  - key: founding-era
    label: "Founding era"
    range: [2006, 2010]
...
tag: The show finding its format confidence — the founding cast at its most dynamic.
slot_argument: Season two adds cast, widens the geography, and discovers what the OC world can sustain. The format gains operational fluency here — more cast movement, higher dramatic stakes, and the show beginning to understand what it actually is.
...
tag: The foundational document — before the format had a name.
slot_argument: Everything in the franchise traces its lineage here. The casting is confident where the format isn't yet. The OC setting does more social work than the production understood. Historically essential; not the show at operational peak.
...
tag: The peak era opens — new cast, higher social register, the OC world shifting upward.
slot_argument: Ranks above the founding era's middle entries because the peak-era format is both more fluent and more ambitious. New cast members shift the economic register and the social pressure is higher and better used.
community_rank_hint: rank=3 delta=0 sentiment=hold

Season six is the start of RHOC's peak era, and it announces that shift with a cast reconfiguration that changes the show's social register entirely. Heather Dubrow's arrival gives the group a new axis of tension — competing versions of aspiration and taste that cut across the existing dynamic. The production is at its most fluent, the cast chemistry is immediate and layered, and the OC social architecture does real narrative work across a twenty-one-episode run. The peak era opens with genuine purpose. Third in the canon, ahead of the founding era's middle entries, because the pressure is higher and better used.

## 7. The Volatility

tag: The peak-era cast at maximum friction — social pressure without novelty to prop it up.
slot_argument: The accumulated cast history generates conflict from first principles. Ranks above the founding-era mid-tier because the social pressure is denser. Below S6 because the new addition briefly disrupts the geometry.
community_rank_hint: rank=4 delta=0 sentiment=hold

Season seven runs the peak-era cast at its most combustible. The social world built across preceding seasons has enough history and competing loyalty structures to generate genuine pressure without novelty to prop it up. Long-running tensions find flashpoints, the cast chemistry is volatile in productive ways, and the production is confident enough to let the dynamics run without manufacturing the stakes. Lydia McLaughlin's debut gives the established social geometry a new refracting point, though the integration is uneven. The peak era at high volume — the cast is doing the work, the format is fluent, and the social pressure is real.

## 3. The Fault Lines

tag: The expanding cast and the first signs of durable franchise conflict.
slot_argument: A transitional entry, competent and watchable. Slots fifth in the expanded canon, held above the founding era's later entries because the social geography it opens is more narratively productive than the consolidation work of S4 and S5.
community_rank_hint: rank=5 delta=0 sentiment=hold

Season three expands the cast and widens the OC social geography, and the show spends part of the season absorbing those changes. The social world grows more complicated — more competing loyalties, more intersecting relationships, a Coto de Caza world that is no longer self-contained. The production handles the expansion competently enough; the format is now fluent even if the season doesn't press its advantages as hard as the second year does. A transitional entry — necessary to the early run's argument, watchable on its own terms, honest about what it is. Fifth slot in the expanded canon, ahead of the founding era's closing chapters.

## 16. The Return

tag: The revival era's strongest cast reset — Heather Dubrow back, new additions that click.
slot_argument: Ranks sixth — the revival cast is more purposefully configured than the founding era's later entries, and the reset energy is stronger than S17's continuation that follows.
community_rank_hint: rank=6 delta=0 sentiment=hold

Season sixteen is the revival era's clearest argument. Three cast members exit, Heather Dubrow returns after four seasons away, and Noella Bergener and Dr. Jen Armstrong arrive with chemistry that produces genuine friction faster than most new additions manage. Heather's return reshapes the social register immediately — her renewed axis with Shannon Beador carries more history and more texture than their first run together. The OC social architecture has real purpose again, and the production is confident enough to run the new configuration without manufacturing the stakes. The revival era's best season by a clear margin.

## 5. The Settlement

tag: The founding era's longest run — cast settled, social geometry familiar, pressure sustained.
slot_argument: Earns the seventh slot above S4 — the settled cast and longer episode run give the dynamics room. Below S16 because the revival's more purposeful configuration outperforms the founding era's sustained middle.
community_rank_hint: rank=7 delta=0 sentiment=hold

Season five closes the founding era with the most episodes the Coto de Caza run ever produced. The cast has settled into its social geometry — competing loyalties and economic aspirations running in parallel — and the show draws out those tensions across a longer run than the earlier seasons managed. The format is fully operational and the cast configuration has enough history to generate conflict without manufacturing it. Not the founding era at its peak pressure, but the founding era at its most sustained. A solid closing chapter that earns its middle-canon position without apology.

## 4. The Departure

tag: The founding circle opens outward — new cast, new social register, the show mid-transition.
slot_argument: The founding era in transition. Ranks below S5 because the settling S5 achieves makes the dynamics more productive. Above S17 because the revival continuation slots below founding-era entries with the OC social world working cleanly.
community_rank_hint: rank=8 delta=0 sentiment=hold

Season four is RHOC in transition — the Coto de Caza founding circle expanding outward as new cast members bring a different social register to the OC world. Alexis Bellino's arrival signals the show beginning to cast for clash rather than community, and the dynamics shift accordingly. The format handles the change competently, and the season has enough genuine social texture to hold attention. A mid-era entry that sits at the lower end of the founding era's output: not the show at its most pressurized, but honest about where it's going and what it costs to get there.

## 17. The Consolidation

tag: The revival era deepens — Tamra Judge returns, the triangulated dynamic has roots.
slot_argument: Slots ninth — below founding-era middle entries (Coto de Caza social world in cleaner operation), but above S8 because the revival cast's accumulated history generates more purposeful pressure than the peak era past its limits.
community_rank_hint: rank=9 delta=0 sentiment=hold

Season seventeen deepens the revival era's argument. Tamra Judge's return after six seasons away brings a cast member with contested history across nearly the entire group. Placed alongside Heather Dubrow and Shannon Beador, the triangulated dynamic generates social pressure with roots rather than manufactured drama. The season runs the format confidently: confrontations are grounded in history, alliances are credible, and the OC social world carries an eighteen-episode run with genuine weight. Solid revival-era television — the cast has real things to say to each other and the show lets them say it.

## 8. The Overstay

tag: The peak era past its operational peak — familiar cast, diluted social pressure.
slot_argument: Peak-era cast run past its productive limits. Social pressure real but unfocused, pulled toward storylines outside the OC architecture. Ranks tenth, above the transition-era and revival-era entries that follow.
community_rank_hint: rank=10 delta=0 sentiment=hold

Season eight keeps the peak-era cast in place across a long episode order and shows the configuration's wear. The core social dynamics are still capable of generating pressure, and the cast chemistry remains genuine, but the season's energy is increasingly pulled toward storylines that sit outside the OC social architecture the show runs best on. The reunion is notable; the broader run is uneven. A peak-era season running past its operational peak — the cast earned more than the season delivers. Tenth in the canon: the peak era at its most diluted, below every season that found a working configuration and above the transition-era entries that followed.
...
slot_argument: Kelly Dodd's debut adds genuine energy and some of the sharpest scenes in this stretch. But the season doesn't fully harness the new dynamic. Thirteenth — above the transition-era entries; below S10's more consistent run.
community_rank_hint: rank=13 delta=0 sentiment=hold

Kelly Dodd's debut is the season's defining variable, and it registers immediately — her collision-seeking energy adds volatility the peak-era cast hadn't carried since the mid-era high points. Some of the scenes she generates are among the sharpest the show produced in this stretch. But the season's energy is unevenly distributed: Kelly's presence heightens some episodes and destabilizes others, and the production doesn't fully harness the new dynamic. Heather Dubrow's departure doesn't land as a closing chapter until the season is behind you. Ranks thirteenth — enough genuine energy to hold above the transition-era entries, not enough coherence to clear the S10 bar.

## 14. The Reconfiguration

tag: The transition era finding its footing — new energy, integration still in progress.
slot_argument: Slots fourteenth — above S12's more unsettled opening move and S13's visible construction work because the cast has more working chemistry here. Below S11 because peak-era fluency still outperforms this transition-era bridge.
community_rank_hint: rank=14 delta=0 sentiment=hold

Season fourteen is the transition era's most functional chapter. Emily Simpson and Gina Kirschenheiter return with better footing than the prior season gave them, and Braunwyn Windham-Burke's arrival injects new social energy into an ensemble that needed it. The cast chemistry is developing rather than finished — some combinations generate genuine friction, others are still calibrating. The Orange County social world has enough texture to hold the season's attention, and the cast is close enough to a working configuration to suggest the rebuild is moving in the right direction.

## 12. The Revision

tag: The transition era opens — the show searching for its next cast configuration.
slot_argument: Without Heather Dubrow, the peak-era social register doesn't carry. New additions don't fully replace what's lost. Genuine texture in places but never a working ensemble. Fifteenth, ahead of S13.
community_rank_hint: rank=15 delta=0 sentiment=hold

Season twelve opens the transition era in earnest. Without Heather Dubrow, the show's peak-era social register doesn't carry, and the season spends most of its run searching for its next configuration rather than running one confidently. Lydia McLaughlin's return generates some cast chemistry but reads differently outside the ensemble that originally framed her; Peggy Sulahian's addition doesn't catalyze the group. There are genuine social textures across the season — the chemistry isn't absent — but the cast hasn't landed yet as a working unit. The transition era's first confirmed step: honest about the search, unresolved about where it leads. Ranks fifteenth ahead of the more fractured S13.
