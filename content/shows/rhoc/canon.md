...
slot_argument: Earns the sixth slot above S4 because the settled cast configuration and longer episode run give the social dynamics more room to develop. Below the transitional S3 because the social world is sustaining rather than expanding.
...
slot_argument: The founding era in transition rather than at its best. Ranks below S5 because the settling S5 achieves makes those dynamics more productive. Above S8 because the peak-era fatigue that defines S8 hasn't set in yet.
