...
take_h2: "Two new judges, real friction."
watch_list:
  ...
  - episode_label: "Auditions · a stand-up run"
    body: "Comedian Taylor Williamson brings a deliberately awkward, deadpan delivery to the audition stage, a style built to land or fail entirely on timing."
  - episode_label: "Auditions · a magic act"
    body: "Magician Collins Key auditions with a close-up sleight-of-hand routine built for the big stage — a format staple that always tests how illusion reads on camera."
