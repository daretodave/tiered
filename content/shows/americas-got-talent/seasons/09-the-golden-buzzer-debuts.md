...
eyebrow: "Aired spring–summer 2014 · Same panel, one new mechanic that changes everything"
...
take_h2: "One button reshapes everything."
watch_list:
  ...
  - episode_label: "Auditions · a second buzzer, a different act"
    body: "Howie Mandel presses his own buzzer for comedy-rap duo Emmanuel & Phillip Hudson's original song 'Ratchet Girl Anthem.'"
  - episode_label: "Auditions · a circus act earns the third buzzer"
    body: "A Cyr wheel acrobatic act earns the season's third buzzer press, extending the new mechanic to a third judge in its debut year."
  - episode_label: "Format · one buzzer each"
    body: "For the first time, every judge at the table has an individual buzzer to use once during the audition rounds — the mechanic that becomes the format's signature going forward."
---
