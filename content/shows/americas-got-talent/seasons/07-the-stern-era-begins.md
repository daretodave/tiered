...
watch_list:
  ...
  - episode_label: "Auditions · the earth harp"
    body: "William Close performs on his own invention, an 'earth harp' with strings stretched the length of the venue — one of the season's most visually distinct instruments."
  - episode_label: "Auditions · a ventriloquist and his dog"
    body: "Todd Oliver auditions alongside his dog act, a format staple that always tests how the panel reacts to novelty comedy paired with genuine technical skill."
  - episode_label: "Auditions · an audition that drew real scrutiny"
