...
number: 62
title: "Season 62"
slug: the-double-first
canonical_position: 21
premiere_date: "2025-07-29"
host: "Ted Allen"
ep_count: 13
cast_size: 4
...
watch_list:
  ...
  - episode_label: "Ted's Takeover · host at the table"
    body: "Ted Allen joins the judging panel as a fourth judge for one hour, only the second time a host has judged in the show's history. Watch how the panel dynamic shifts with him across the table instead."
  - episode_label: "No Kid Hungry hour · the pantry problem"
    body: "The reordered rounds draw from a different pantry than a standard round would — savory morning staples don't overlap with a sweet basket the way an entrée's ingredients would. Watch the chefs adjust their instincts to a sequence the format has never asked of them before."
  - episode_label: "Ted's Takeover · judging from the other side"
    body: "The host spends the hour on the panel instead of running it, changing what gets asked and how a critique lands coming from someone who has hosted every prior season. Watch for how the other judges react to his read on a plate."
---
