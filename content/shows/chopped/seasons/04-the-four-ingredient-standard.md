...
watch_list:
  ...
  - episode_label: "Appetizer round · a tighter constraint"
    body: "The fixed basket size leaves chefs less room to hide a weak idea behind extra components. Watch how that constraint changes the math chefs do in their heads during the reveal."
  ...
  - episode_label: "Judges' table · a cleaner comparison"
    body: "With every chef working from the same-sized constraint, the panel's critique has a more consistent baseline to argue from. Watch how specific the judges get once the basket stops shifting round to round."
---
