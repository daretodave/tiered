---
slug: twice-in-one-year
title: "Twice in one year"
description: "Competition television used to run twice as often as it does now. These are the seasons that arrived a second time before the calendar year closed — spring and fall premieres stacked into the same twelve months, back when the pace could still hold."
tagline: "For the better part of a decade, competition television didn't wait a full year between premieres — a spring season closed and a fall season opened before the calendar flipped, again and again, until the pace itself became the story. <b>Every season here has a same-year sibling it was built to run alongside.</b>"
category: era
sentiment: hold
status: started
