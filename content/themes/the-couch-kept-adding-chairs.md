---
slug: the-couch-kept-adding-chairs
title: "The couch kept adding chairs"
description: "A Real Housewives cast is never a fixed headcount — a franchise can add three new full-timers in one season and cut the roster in half the next. This ranks the swings that reshaped the group hardest, one Bravo city at a time."
tagline: "Every Real Housewives franchise treats its cast size as a lever, not a constant — <b>a single season can add three new full-timers or cut the roster in half, and either move resets the whole group's chemistry</b>."
category: craft
sentiment: hold
status: stable
...
entries:
  - show: rhoslc
    ...
    season_label: "S03"
    rank: 1
    title: "Salt Lake City cuts its cast almost in half in a single season"
    blurb: "Season two closes at seven voices; season three opens at four, with Mary Cosby stepping back to a reduced role. The tightest episode order the show has run frames the sharpest single-season contraction any Housewives cast has taken."
  - show: rhoslc
    season: 4
    season_label: "S04"
    rank: 2
    title: "The same city rebuilds from four back up to six, one confident addition at a time"
    blurb: "A season after its steepest contraction, Salt Lake City adds two new full housewives and brings Mary Cosby back in a reduced capacity. The cast doubles its headcount without diluting the core four who anchored the leaner season before it."
  - show: rhod
    season: 2
    season_label: "S02"
    rank: 3
    title: "Dallas grows its founding four to six, and the expansion holds"
    blurb: "The founding cast expands to six as D'Andra Simmons and Kameron Westcott join a returning core of four. Unlike most swings on this list, the wider circle proves durable — the same six-woman lineup carries into Dallas's next season completely unchanged."
  - show: rhom
    season: 3
    season_label: "S03"
    rank: 4
    title: "Miami tightens its roster right before an eight-year pause nobody saw coming"
    blurb: "The original run's final season settles at five full-time housewives, its leanest cast since the debut. Nobody involved knew it yet, but this shrinking roster would be the franchise's last new season for the better part of a decade."
  - show: rhom
    season: 2
    season_label: "S02"
    rank: 5
