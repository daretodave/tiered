...
description: "A full year between premieres is the usual reality-TV rhythm. These seven pairs broke it — two because production genuinely filmed back-to-back, the rest because the turnaround itself simply ran short. Ranked by how tight the gap actually ran."
tagline: "Reality TV runs on an annual clock, but these seven pairs broke it — two of them because production genuinely filmed back-to-back, the rest because the turnaround itself simply ran short. <b>Ranked by how tight the calendar gap between premieres actually ran.</b>"
category: craft
sentiment: hold
status: growing
...
related:
  - twice-in-one-year
  - the-batch-drop-settles-in
entries:
  - show: selling-sunset
    season: 2
    season_label: "S02"
    rank: 1
    title: "The tightest premiere-to-premiere gap in this list opens with a bigger roster"
    blurb: "The full founding roster returns and grows by three agents, testing whether a bigger office keeps the same friction sharp. The season that follows premieres just 77 days later — the shortest gap between any two premieres ranked here."
  - show: selling-sunset
    season: 3
    season_label: "S03"
    rank: 2
  ...
  - show: too-hot-to-handle
    ...
    season_label: "S04"
    rank: 7
    title: "A brand-new villa opens a turnaround that lands squarely mid-pack here"
    blurb: "Season four moves the format into a new Emerald Pavilion villa, hiding the real show behind a fake cover story for its opening episodes. The next season premieres 219 days later — tighter than every gap ranked above it, wider than every gap below."
  - show: too-hot-to-handle
    season: 5
    season_label: "S05"
    rank: 8
    title: "The other half of that turnaround keeps the format running steady"
    blurb: "Season five returns to the same Emerald Pavilion villa and runs the rolling-cast structure at full confidence, no new mechanic layered on top of it. The two premieres land 219 days apart — tighter than every gap ranked above it here, wider than every gap ranked below."
