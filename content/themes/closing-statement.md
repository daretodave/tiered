...
description: "The literal last season a canceled show ever filmed, ranked by how deliberately production chose to close the format out — an announced farewell and a returning face, or a season with no idea it was the last one."
tagline: "A canceled show's last season isn't always billed as one. Some got an advance goodbye and a returning face for closure; others just stopped after a season that played like business as usual. <b>This list ranks the send-off, not the finish.</b>"
category: craft
sentiment: verdict
status: growing
...
entries:
  - show: queer-eye
    ...
    rank: 1
    title: "Netflix announces the ending mid-production, and the show gets to plan its own goodbye."
    blurb: "The shortest episode order in the show's history, filmed across three D.C.-area jurisdictions, with Jeremiah Brent back for a second and final round in the design chair. A farewell season built on its own terms."
  - show: jersey-shore
    season: 6
