...
entries:
  - show: survivor
    ...
    blurb: "Half the tribe walked in already labeled villains, reputations loaded in before the first vote. The edit lets every confrontation land hard because the audience walked in with the receipts. No other returnee season has tried to run ten antagonist arcs in parallel."
  - show: survivor
    season: 7
  ...
  - show: amazing-race
    ...
    rank: 6
    title: "Returnees racing with enough history to make every clash land."
    blurb: "All-Stars brings back eleven teams the audience already had relationships with, and the editing captures the confrontational chemistry only prior race history can produce. The antagonist energy here is years in the making, and the edit never lets it idle."
  - show: survivor
    season: 28
