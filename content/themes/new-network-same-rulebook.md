---
slug: new-network-same-rulebook
title: "New network, same rulebook"
description: "A network move is rarely a creative call — it's a renewal fight, a corporate merger, a streaming deal closing. What this list tracks is how each show absorbed the landing: new call letters, sometimes a new host or judge, the same format underneath."
tagline: "Renewal politics, a merger, a streaming deal closing — a network move is corporate math, not a creative choice. <b>This list ranks how each show absorbed the landing, not why the move happened.</b>"
category: structure
sentiment: hold
status: growing
...
entries:
  - show: project-runway
    ...
    season_label: "S17"
    rank: 1
    title: "The Bravo return keeps the workroom and rebuilds everything else around it."
    blurb: "Project Runway comes home to Bravo with a new host, a former winner installed as mentor, and a refreshed judges' table — every seat turns over except the one that matters least: the workroom itself."
  - show: bake-off
    season: 8
    season_label: "S08 · The Channel 4 Reset"
    rank: 2
    title: "New hosts, a new judge, and a new network land in a single tent-preserving move."
    blurb: "Channel 4 arrives with Sandi Toksvig and Noel Fielding replacing Mel and Sue, Prue Leith joining Paul Hollywood at the judges' table, and Welford Park held onto as the one constant carrying the audience across."
  - show: dragrace
    season: 9
    season_label: "S09"
    rank: 3
    title: "The franchise's biggest production jump lands with its judging spine intact."
    blurb: "VH1 brings a bigger budget and a Lady Gaga premiere at the judges' table, but RuPaul and Michelle Visage stay put — the scale changes, the panel's foundation doesn't."
  - show: american-idol
    season: 16
    season_label: "S16 · The Network Return"
    rank: 4
    title: "A completely new panel walks into the ABC premiere, and the ratings answer fast."
    blurb: "American Idol's ABC debut swaps every judge — Katy Perry, Lionel Richie, Luke Bryan — while Ryan Seacrest stays at the podium. The chemistry clicks quickly enough that the debut becomes the era's ratings peak."
  - show: project-runway
    season: 21
    season_label: "S21"
    rank: 5
