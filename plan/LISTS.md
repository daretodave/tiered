...
| when-scripted-went-dark | era | 2026-08-07 | 2026-08-07 | extended 2026-08-07 (twenty-second Rule-3 pass, content-curator tick: 12→14 entries, 11→13 shows). America's Got Talent S18 "The Settled Run" entry, rank 13 — premiere_date confirmed May 30, 2023, four weeks into the WGA walkout (May 2–Sep 27, 2023), and the season's own lede/pull state plainly it's "the third full run of the Cowell-Klum-Vergara-Mandel configuration" running "in a practiced shape" — a clean strike-window date paired with a settled-panel texture distinct from the list's existing entries. Below Deck Mediterranean S08 "Italian Riviera" entry, rank 14 — premiere_date confirmed September 25, 2023, inside the joint WGA/SAG-AFTRA overlap (SAG-AFTRA ran July 14–Nov 9, 2023; WGA hadn't yet lifted), and the season's own lede states the charter "moved west along the Italian coast — Genoa and the Riviera" for the first time, giving Bravo's second entry on this list a genuinely new specific fact (a location first, not a cast-growth fact like Southern Charm S09 or RHOC S03). Both confirmed non-duplicative via full `show: americas-got-talent` and `show: below-deck-mediterranean` greps across every `content/themes/*.md`: AGT S18's only other ledger appearance (`two-coasts-one-open-call` rank 14) stakes an unrelated location-record-continuity fact (Hollywood-only credit, unbroken); Below Deck Mediterranean S08 appears once, in `the-command-held-for-nine-seasons-then-didnt` rank 8, staking a cast-friction/command-authority fact, not the westward-relocation fact used here. Several other candidates surfaced by a premiere_date sweep of the WGA (2023-05-02–09-27) and SAG-AFTRA (2023-07-14–11-09) windows were considered and rejected as already claimed for the exact fact this list would need: Ink Master S15 and American Ninja Warrior S15 (both heavily mined elsewhere for the same rookie-cast/qualifying-tour facts, ANW S15 alone staked three times); The Voice S25, DWTS S32, The Challenge S39, and Queer Eye S07 (each already staked near-verbatim for the same settled-panel/co-host/no-rookies/last-original-cast fact this list would restate); Hell's Kitchen S22 (staked three times already for its international-cast/last-California-season fact); MasterChef S13 (staked verbatim for its regional-teams-dissolve-at-midseason fact in `every-season-tests-a-new-theory-of-the-kitchen`); Love Island UK S10 (its milestone-tenth-series framing already staked in `the-fire-pit-never-moved`); Alone S10 (its first-winter-format fact already staked in `the-ten-items-are-never-the-same-ten-items`); Bake Off S14 (Channel 4/UK production, no genuine tie to a US network-scheduling disruption, thematic mismatch same as the earlier-rejected MasterChef Australia). Inserted at ranks 13-14, after the existing rank-12 Selling Sunset capstone entry, in chronological order relative to each other (AGT S18 May 30 before Below Deck Med S08 Sep 25). List now runs 14 entries across 13 shows, no show over 2. |
