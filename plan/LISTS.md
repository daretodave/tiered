...
| where-the-warmth-ran-out | tone | 2026-08-16 | 2026-08-16 | extended 2026-07-30 (12→13 entries, 12→13 shows). RHOSLC S02 entry, rank 4 — the season's own lede/watch_list text states the show's longest episode order yet is "a stress test for how far the founding cast's chemistry stretches once a seventh voice enters the room," with the watch_list's late-season beat noting "the back half starts testing where everyone in the group actually stands with each other," a direct match for this list's warm-open/colder-close thesis. Confirmed via a full `show: rhoslc` grep across every `content/themes/*.md` that S02 had zero prior appearances anywhere in the ledger (the show's other five seasons appear across five different lists, but S02 itself was untouched) — genuinely unclaimed. First Real Housewives of Salt Lake City entry on this list; inserted at rank 4, directly below the three existing Real Housewives franchise entries (rhonj, rhoc, rhony), with southern-charm through the-challenge shifted from ranks 4-12 to 5-13. **extended 2026-08-16** (cloud march tick, content-curator, Rule-2 season-fill confirmed stalled — `plan/CADENCE.md`'s entire gap table starred, fell through to Rule 3; extend-first strategy, no ledger row cleared the 90-day review-due bar): 13→14 entries, 13→14 shows, first Real Housewives of Miami entry on this list. RHOM S01 entry, rank 5 — the season's own file states plainly its pull is "old friendships under new pressure — the tone this Housewives chapter has kept circling back to," and its lede frames the founding six as navigating "old friendships tested by ambition," a direct, self-described match for this list's warm-open/colder-close thesis. Confirmed via a full `show: rhom` grep across every `content/themes/*.md` that S01's five prior ledger appearances (`best-newbie-casts` rank 9 — casting-lands-immediately fact; `wealth-as-the-whole-pitch` rank 5 — wealth-as-hook fact; `new-flags-planted-fast` rank 10 — tone-set-for-the-franchise fact; `the-company-upstairs-changed-hands` rank 4 — Comcast/NBCUniversal timing fact; `the-wait-between-seasons-was-never-the-same-twice` rank 7 — hiatus-gap fact) each stake a materially different facet of the same season — none touches the friendship-under-ambition-pressure thermal arc staked here. Inserted at rank 5, directly below the four existing Real Housewives franchise entries (rhonj, rhoc, rhony, rhoslc), grouping every RH entry together before southern-charm through the-challenge shift from ranks 5-13 to 6-14. List now runs 14 entries across 14 shows, one entry per show, well clear of the cross-canon floor and any per-show cap. |
...
| built-for-the-drop | craft | 2026-08-15 | 2026-08-15 | extended 2026-07-31 (13→15 entries, 8 shows unchanged) — Traitors S03 (rank 14): `03-ardross-2025.md` premiere_caption "Peacock · 3-episode drop then weekly" confirms the S02 launch-drop-then-weekly split holds again, turning a launch experiment into the format's house rhythm; cross-checked S03's 5 other ledger appearances (hosting/twist/finale/vote angles), none stake release cadence, and deliberately skipped S04 since `running-on-muscle-memory` already quotes the identical phrase. Too Hot to Handle S05 (rank 15): `05-season-5.md` premiere_caption "Netflix · July 2023, staggered release" / episodes_caption "10 episodes across three release batches" — a third, settled data point after S01's full-batch debut (rank 5) and S02's first staggered experiment (rank 10); cross-checked THH S05's other 2 ledger appearances (prize-mechanic, rolling-cast angles), clean. **extended 2026-08-15** (Rule 3 tick, content-curator): 15→16 entries, 8→9 shows. Queer Eye S01 "Georgia" entry, rank 16 — first appearance of this show on the list; grounded directly in the season's own `premiere_caption: "Netflix · full season drop"`, and confirmed via a full grep of `premiere_caption` across all ten of the show's season files that every single one reads identically ("Netflix · full season drop"), so the entry's "never once revisits the choice" claim is a verified cross-season fact, not an inference. This is a distinct angle from Queer Eye's other two relevant ledger appearances — `moving-day` rank 2 stakes the network-move-plus-format-refresh fact (Bravo original to Netflix reboot), and `a-show-that-never-had-a-home-address` rank 7 stakes the location-anchoring fact (Georgia as the address the format eventually leaves) — neither touches release cadence, the craft angle this list owns. Extend-first search this tick ran wide before landing here: chased and rejected a Love is Blind S3+ candidate (no release-cadence detail in any post-S2 season file, and S1/S2 are already spent here), a Drag Race All Stars Paramount+-move candidate (S06's own file states only the network move, no batch/weekly cadence detail — already the network-move fact's natural home is `moving-day`/`new-network-same-rulebook`, not this list), a DWTS S31 Disney+ candidate (confirmed already staked verbatim at `moving-day` rank 10, and it's a live weekly simulcast, not a batch-drop craft fact regardless), and a Love Island US Peacock candidate (nightly episodic release, not a batch rhythm — off-thesis). Also swept american-ninja-warrior, naked-and-afraid, and the below-deck sub-franchises for the sibling `the-place-fought-back` (tone, location-adversity) list on the same pass — rejected: naked-and-afraid's anthology-format season files name no specific biome or extreme condition per season (would require inventing detail the files don't carry), below-deck-mediterranean/below-deck-sailing-yacht season files carry no storm/weather-adversity language, and rhodubai's only near-hit ("genuine friendships" vs. "performative ones") is a cast-dynamics observation, not a location-adversity one — off-thesis for that list. |
| closing-statement | craft | 2026-08-10 | 2026-08-15 | **corrected 2026-08-10 (cloud march tick):** 11→10 entries, 11→10 shows. Removed the `show: the-voice, season: 29` entry (formerly rank 3) — a confirmed live instance of the fabricated "series finale" claim documented by the standing the-voice factual-corruption row in `plan/AUDIT.md` (score 4.8, filed 2026-07-26); this entry's title/blurb restated the same false "the show has ended" claim in a second, independent surface, git-blamed to `92d1be9b` (2026-07-17), predating the corruption's discovery. Scoped subtraction only — no new the-voice content authored, per the standing row's block on authoring content tied to any the-voice season ≥22 until the full remediation lands. Remaining ranks renumbered contiguous (4→3 through 11→10); every other entry's fact/framing untouched. extended 2026-07-30 (9→10 entries, 9→10 shows). Below Deck Adventure S01 entry, rank 10 — the show's own frontmatter documents `seasons: 1` and `status: ended`, and the season's own file carries zero farewell framing (no reinvention narrative, no advance notice) despite the format never getting picked up for a second charter; confirmed via a full `show: below-deck-adventure` grep across every `content/themes/*.md` that the season's four prior appearances (`two-channels-same-night` dual-network-simulcast fact, `the-paycheck-writes-the-plot` crew-hierarchy-pressure fact, `the-place-fought-back` Arctic-terrain fact, `new-flags-planted-fast` franchise-expansion fact) never touch the show's actual non-renewal. Inserted at rank 10, below The Apprentice S15 — even less self-aware than that reboot's reinvention narrative, since this season carries no ending signal at all, just a normal launch that quietly never returned. First Below Deck-franchise entry on this list; list now runs 10 entries across 10 shows, one entry per show. **extended 2026-08-04 (hundred-and-first pass):** 10→11 entries, 10→11 shows. RHOD S05 "The Closing Chapter" entry, rank 11 — the season's own file states Bravo "billed, at the time, as RHOD's final season," with all five returning Housewives plus one new addition, and names a resurfaced-clip controversy that drew "outside the show's usual press cycle" — a billed-farewell-overtaken-by-off-camera-noise fact distinct from every other entry's clean sentimental-or-oblivious send-off. Confirmed via a full `show: rhod` grep across every `content/themes/*.md` that RHOD's four prior appearances (`new-flags-planted-fast` S01 debut-cast fact, `the-couch-kept-adding-chairs` S02 cast-growth fact, `tried-once-never-repeated` S03 consolidation fact, `the-slow-build-was-the-point` S04 reckoning fact) never touch S05, leaving it fully unclaimed — and that no other list stakes the show's status:hiatus non-renewal. Followed the sibling RHOD entries' own precedent (`tried-once-never-repeated` S03, `the-slow-build-was-the-point` S04) in using the `S05 · The Closing Chapter` suffix, since it matches the season's own frontmatter `title` exactly. List now runs 11 entries across 11 shows, still one entry per show. Re-checked 2026-08-15 (cloud march tick, Rule-2 stalled fallback to Rule 3): drafted and reverted a the-voice S29 "The Finale" candidate entry — caught before finalizing that `plan/AUDIT.md`'s standing HIGH row (score 4.8, issue #762) documents this exact "final season / fourteen years" framing as fabricated/disputed, and this list already had a the-voice entry removed once before for the same reason (2026-08-10). File reverted to its exact prior state, no entry added. No change. |
...
| not-who-they-say-they-are | craft | 2026-08-06 | 2026-08-06 | extended 2026-07-30 (11→12 entries, 4→5 shows). Big Brother S06 "Summer of Secrets" entry, rank 12 — the season's own file states plainly "every houseguest walked in with a secret partner" ("format_caption"), a hidden-pairs twist that its own body text says makes the season "a casting season as much as a twist season" where "the alliance math gets dense fast" — the concealment mechanic structurally driving the whole run, not a one-episode decoration. First non-Circle/Traitors/Masked-Singer show on this list. Confirmed via a full `show: big-brother` grep across every `content/themes/*.md` that S06 has exactly one prior appearance (`every-summer-gets-its-own-twist` rank 12), which frames the same hidden-pairs fact through a different lens (comparing S06's twist to S09's later couples format across the franchise's twist history) rather than this list's concealment-carries-the-format thesis. Ruled out before landing here (per the brief's own prior findings, not re-litigated): Big Brother S08 "America's Player" (staked 3x elsewhere), Big Brother S27 "A Summer of Mystery" (premiere-night decoration, not structural), Traitors UK S03/S04 and Traitors US S04 (no fresh concealment fact in their own season files). Also checked and rejected: Real World S32 "Seattle: Bad Blood" (its cover-story/hidden-history fact is already staked near-identically at `the-grudge-was-the-casting-call` rank 2); MasterChef Australia S15 "Secrets and Surprises" (its secret-apron/blind-tasting concealment fact is already staked near-identically at `not-knowing-was-the-point` rank 5); Big Brother S05 "Project DNA" twin-swap (already staked at `every-summer-gets-its-own-twist` and `the-resemblance-was-never-just-a-fun-fact`). **extended 2026-08-06 (tenth 2026-08-06 pass, content-curator tick; 12→13 entries, shows unchanged at 5).** Big Brother S18 "Vets And Newbies Reprise" entry, rank 13 — the season's own file states plainly "the Roadkill twist gives the week a secret third nominator the house has to identify," a hidden power-role the house must actively deduce, structurally parallel to this list's existing Traitor/Joker/Superinfluencer secret-role entries rather than a one-week decoration. Confirmed via a full-catalog `show: big-brother` + `season: 18` grep that this season had exactly one prior appearance (`every-summer-gets-its-own-twist` rank 18), which stakes a different fact about the same twist — that Roadkill "undoes whatever plan the Head of Household just built" — never mentioning the secrecy/deduction angle this entry stakes instead. Considered and rejected before landing here: Big Brother S08 "America's Player" (already staked 3x elsewhere including `every-summer-gets-its-own-twist`'s own "the house can't see" framing — confirmed via grep, a near-duplicate of what this list would need); Big Brother S05 "Project DNA" (already staked 4x elsewhere for the identical twin-swap fact); The Circle S04 "Celebrity Catfish Season" (the concealment-from-the-cast angle isn't stated outright in the season's own file text — only the economic no-prize framing is, and that's already staked at `same-crown-new-price-tag` rank 7 — declined to infer the unstated fact); The Circle S02 "Joker Twist," S05 "Circle Singles," S07 "Disrupter Mode" (their own secret-role twists read as incremental format tweaks on the format's founding mechanic, not a fresh angle, and Circle already sits at 3 entries on this list); Traitors UK S03/S04 and Traitors US S04 (schedule/after-show/cast-familiarity facts, no fresh concealment mechanic in their own season files — re-confirmed, matches the 2026-07-30 note's finding). |
...
| pre-recap-culture-seasons | era | 2026-08-06 | 2026-08-06 | extended 2026-08-06 (cloud march tick, sixteenth Rule-3 pass, 17→18 entries, 17→18 shows). The Real World S20 "Sydney" (2007) entry, rank 18 — the season's own `eyebrow`/`format_caption` fields state verbatim "the first season shot outside North America or Europe," premiering 2007-06-26, a dated geographic-milestone fact well inside the list's 1992–2008 pre-social-media era_range and its own first-ever appearance anywhere in the ledger (confirmed via a full `show: the-real-world` + `season: 20` grep across every `content/themes/*.md`). A second grep for "Sydney" ruled out overlap with `the-city-already-had-a-show` rank 11, which name-drops the same year/city as color for an unrelated ANTM entry, never staking Real World S20 itself. Checked `no-template-to-copy` (era, 2000–2005) for extend headroom first — dead end, every catalog show with an `est_year` in that window is already on the list. Previously extended 2026-07-31 (14→17 entries, 14→17 shows). Bachelor S01 "Alex Michel" (rank 15) and Bachelorette S01 "Trista Rehn" (rank 16) — both season's own files confirm 2002/2003 premiere dates and six-episode debut runs, well inside the list's era_range; grounded on the list's own pre-social-media timing thesis, distinct from these seasons' existing appearances (played-it-straight, not-the-usual-order, the-mic-changed-hands, a-guest-spot-with-room-to-grow), none of which stake the recap-culture-timing fact. So You Think You Can Dance S01 (rank 17) — own file confirms a July 2005 premiere and an open-call founding format, distinct from its existing appearance at the-open-call-built-the-format (format-founding-bet fact, not the timing fact). Confirmed via full `show:` greps across every `content/themes/*.md` that none of the three seasons had a prior appearance on this specific list. List now runs 18 entries across 18 shows, no show over 1 entry. |
| milestones-spent-not-marked | craft | 2026-08-06 | 2026-08-06 | **extended 2026-08-06** (eleventh 2026-08-06 pass, content-curator tick — Rule 2 season-fill re-confirmed stalled per `plan/CADENCE.md`'s fully-starred gap table, next sweep due 2026-08-09; review batch re-confirmed empty, oldest `last_reviewed` still `survivor-pillars` at 2026-07-31; skipped the seven lists already touched today per the brief's skip-list — `best-premieres`, `best-challenge-design`, `best-returnees`, `when-the-crew-stepped-into-frame`, `not-who-they-say-they-are`, `best-location-reveals`, `away-from-home-turf`). Picked this healthy, untouched-today craft list (22/24-30 entries, `last_revised` 2026-07-29) and grepped every show's season files catalog-wide for `nniversary|milestone` to surface untapped round-number-occasion seasons. The Challenge S30 "XXX: Dirty 30" entry, rank 6 (inserted directly below the S20 World All-Stars entry; existing ranks 6-22 shifted to 7-23) — the season's own file states plainly in its eyebrow/lede/pull that it's "the franchise's milestone season," a "30th-season returnees event" running "multiple structural twists across the run — ambushes, a redemption-house elimination track, the longest cast list the franchise had assembled," with the body confirming "the architecture is the most layered the franchise had attempted to date" — a direct match for this list's occasion-rebuilds-the-format thesis, comparable in weight to the existing Survivor S40/S50 and Big Brother S25 top-tier entries. Confirmed via a full `show: the-challenge` + `season: 30` grep across every `content/themes/*.md` that this season's three prior appearances stake distinct facets, none the milestone-rebuild claim itself: `best-reunion-specials` rank 3 stakes the *post-season reunion hour's* own anniversary framing ("the show's own anniversary, properly marked") — a claim about the closing special, not the season's in-run architecture; `the-elimination-round-never-keeps-its-name` rank 11 stakes the *naming convention* carrying structural branding load ("Dirty 30 has to brand a returnee event... under one title"); `best-post-merge` rank 7 stakes the *endgame-compression* fact (politics tightening, eliminations accelerating pre-final). Read all three in full before drafting to confirm none pre-empts the season-wide format-rebuilt-around-the-number claim staked here. List now runs 23 entries, shows unchanged (the-challenge now 2/23 on this list, alongside its existing S40 Battle of the Eras entry at rank 4 — both are genuine, differently-numbered milestone occasions for the same franchise, matching the list's own precedent of Americas Got Talent and Project Runway each holding two milestone entries at different round numbers). `last_revised` bumped (real content change). Considered and rejected before landing here: Amazing Race S10/S20/S30 (none of the three season files frames its round number as a marketed anniversary occasion — S20's own text even reads as deliberately unremarkable, "competent... without reaching for novelty," too thin a milestone claim without an explicit anniversary tag); a from-scratch check of The Circle's `seven-ways-to-break-the-same-app` (single-show, all 7 filed seasons already claimed, no room) and Below Deck Sailing Yacht's `the-quiet-register-was-the-whole-point-until-ibiza` (single-show, all 5 filed seasons already claimed) confirmed both fully capped, not viable extend targets. Previously extended 2026-07-29 (Survivor S50 entry, rank 2 — the season's own file frames it as the largest cast in franchise history (24 returning castaways) playing a set of format mechanics fans voted on months before filming, a genuine occasion-rebuild distinct from the same season's two prior ledger facets, the oversized-cast angle in `the-cast-outgrew-the-format` and the fan-vote-authority angle in `who-actually-got-the-vote`; existing ranks 2-21 shifted to 3-22, list now runs 22 entries); previously extended 2026-07-27 (So You Think You Can Dance S12 entry, third extension today). |
...
| one-season-two-flags | structure | 2026-08-05 | 2026-08-21 | extended 2026-08-05 (content-curator tick, Rule-2 season-fill fully stalled — every remaining gap-slot confirmed-but-unaired per `plan/CADENCE.md` — fell through to Rule 3; a parallel attempt this same tick to extend `the-vote-left-the-phone-line` came up empty after exhaustive research, left untouched with a research note there instead): 8→9 entries, 8→9 shows. MasterChef (US) S16 "Global Gauntlet" entry, rank 4 (inserted directly below the existing ANTM S18 British Invasion entry, above Top Chef S20; existing ranks 4-8 shifted to 5-9) — the season's own frontmatter states plainly "twenty home cooks in four regional groups — Europe, Asia-Pacific, Africa, and the Americas — in a World Cup-inspired structure" (`format_caption: "filmed in Toronto; World Cup-inspired regional mechanics"`), a direct match for this list's explicit-national-divide-structures-the-whole-season thesis, and the most elaborate divide on the list (four regions rather than a binary split). Confirmed via a full `show: masterchef$` grep across every `content/themes/*.md` that S16 has exactly one other ledger appearance, `the-competition-leaves-the-country` rank 11, which stakes a materially different fact — the flagship physically relocating production to Toronto (a travel/relocation claim) — with the four-region split appearing there only as supporting texture, not the staked fact itself; this mirrors the ledger's own established precedent one section up, where Top Chef S20 already carries both a relocation fact (`the-competition-leaves-the-country` rank 3) and this exact list's international-cast fact (rank 5, this list) from the same season with no double-dip flag raised. First masterchef entry on this list. Considered and rejected as off-thesis or too thin during this pass: Alone Australia S02 "Fiordland" and Jersey Shore S04 "Florence" (both explicitly "the show's first/only international season" in their own frontmatter, but both are a location move for an unchanged cast, not a national-divide split or an imported sibling-edition roster); MasterChef Australia S09 "Japan" and S16 "Four Voices" (both genuine international-location episodes — Tokyo, Hong Kong — but travel blocks within an otherwise unchanged domestic cast, not a structuring divide); RHOP S03, RHOBH S07, RHONY S10 "The Cartagena Run" (all single international group-travel trips, no casting-pool divide); Bachelor S12 "Matt Grant" and Bachelor S09 "Lorenzo Borghese" (a single lead's nationality/heritage, not a season-wide cast split); ANTM S17 "The All Stars" (all-returnee reunion cast, no national divide); Traitors (US and UK) and Big Brother (US) — swept both franchises' full season files for a sibling-edition import or nationality-line casting split, found none. Bachelorette S05/S06/S07/S09/S14 (all "heaviest international run yet" language, but describes the lead's date-travel itinerary, not a cast-composition split). List now runs 9 entries across 9 shows, no show over 1 entry. **Re-verified 2026-08-05, second pass (content-curator direct invocation, independent re-search):** swept roughly 30 additional season files across shows not touched by the extend pass above — Too Hot to Handle S02/S06 (prize-mechanic and "Bad Lana" twists; the cast is sourced internationally every season by default, so no single run "breaks" from a domestic norm the way this list's thesis requires), Chopped S36 "Gold Medal Games" (a themed tournament block, not a cast-nationality split) and S53 "All-American Showdown" (a US-regional West/North/South/East bracket, domestic not international), The Circle S07, American Ninja Warrior S03/S17, The Apprentice S08 "The Reshuffle"/S09 "The Variance"/S13 "The All-Stars Cycle" (gender- or return-status splits, no nationality line), Dancing with the Stars S24, Drag Race All Stars S03/S05, Drag Race UK S02 "Series 2", Queer Eye, Project Runway (all-New-York run), MasterChef Australia S08 "California"/S09 "Japan" (travel weeks for an unchanged domestic cast, not a casting-pool divide), ANTM S09 "The China Turn" (two-city travel leg, same domestic cast) and S17 "The All Stars" (all-returnee reunion, no national divide — already covered above), Amazing Race S07 (a Survivor-alumni crossover, not a national-line cast split), and Love Is Blind. None of these season files state an explicit national-line cast divide or a full imported sibling-edition roster in their own frontmatter or body text — confirmed via direct reads, not grep alone, for every file above. No genuinely new, well-grounded 10th distinct show cleared the bar this pass. List holds at 9 entries / 9 shows, unchanged from the extend earlier today; `last_revised` not bumped (no real content change this pass, per the ledger's own bump rule), `last_reviewed` reconfirmed 2026-08-05. **2026-08-15 pass (content-curator tick): zero-ship, third confirmation.** Rule 2 gap table re-checked, still fully starred, fell through to Rule 3 per dispatch. Read this list and both related lists (`familiar-faces-wrong-franchise`, `same-license-different-rules`) in full first per the brief, then swept season files across shows outside the existing 9-show set: Drag Race All Stars S06 (largest-cast-yet + Paramount+ move, no nationality split), Drag Race UK S01 (Visage's panel debut, domestic), Amazing Race S07/S34/S38 (Survivor-alumni crossover, first-non-US-start location shoot, and a Big Brother-alumni crossover field respectively — none is a nationality-line split or an imported-roster-from-a-sibling-*international*-edition; S38's Hoorn/Big Brother tie-in is a same-country cross-franchise import, not a two-flags fact, and overlaps `familiar-faces-wrong-franchise`'s thesis instead), MasterChef Australia S09 "Japan"/S16 "Four Voices" (travel weeks on an unchanged domestic cast, already rejected in the 2026-08-05 passes above), Top Chef S22 "Destination Canada" (cross-border road-show location, not a cast split), Too Hot to Handle S06 (same-franchise alumni crossover, single flag), The Circle season files, Love Island UK season files, Traitors UK S02-S04, Traitors (US) S04, Big Brother S02/S27 (in-house vote mechanics, not a casting-pool divide), Married at First Sight (US) and Married at First Sight Australia full season lists, Project Runway (all New York), and Bake Off (all UK domestic) — swept for `international`/`crossover`/`imported`/nationality-adjective keywords via grep first, then read every hit in full. Zero candidates cleared the thesis; every real international-content hit either duplicates a fact already staked here or on the two related lists, is a cross-border shoot/travel block on an unchanged cast, or is a same-country sibling-franchise import (a `familiar-faces-wrong-franchise` fact, not a two-flags fact). Also spot-checked the fallback list named in this tick's brief, `the-vote-left-the-phone-line` (era, 8/8, exhaustively dead since 2026-08-05 per its own standing note) — grepped the full catalog for `online vot`/`digital vot`/`app vot`/`vote online`/`vote via` plus a broader `vote by text`/`voting app`/`call-in`/`phone line`/`toll-free` sweep; every hit resolves to a season already staked on that list or previously rejected (SYTYCD S08, already duplicated at `rulebook-rewritten-every-season` rank 13). No season not already visible to the 2026-08-05 passes has landed in either list's search space since. Both rows remain genuinely exhausted; `last_revised` not bumped on either (no content change), `last_reviewed` bumped to 2026-08-15 on this row only. **Re-checked 2026-08-21 (content-curator direct invocation, fourth-plus same-day Rule 3 pass, dispatched specifically to extend this list): zero-ship, independent re-confirmation.** Worked the brief's ranked candidate search from scratch before reading this row's own history, then cross-checked the result against the log above and landed on the identical dead-end set. Read every file the 2026-08-05 passes name plus a fresh batch outside them: dragrace-uk S02 "Series 2" (Pinewood-Studios production-scale growth, panel finding its voice — no cast split), dragrace-allstars S10 "Tournament of All Stars" (18-queen bracket record, but the split is by random bracket assignment, not nationality), masterchef-australia S09 "Japan" (Tokyo/Mount Fuji challenge weeks on an unchanged domestic cast — re-confirms the 2026-08-05 verdict independently), top-chef S22 "Destination Canada" (a cross-border road-show location for one unchanged cast, not a casting-pool split or import — same shape as the already-rejected S18/Morocco/Cartagena location entries), jersey-shore S04 "Florence" (own frontmatter states "the same seven roommates from Season 3, no additions or departures" — a location move with zero roster change, already logged 2026-08-05), the-real-world S31 "Go Big or Go Home" (imports Challenge/Road Rules *game mechanics*, not a national cast split, and is a same-franchise self-borrow already staked at `the-franchise-started-borrowing-from-itself` rank 10), the-challenge S11 "The Gauntlet 2" (Veterans-vs-Rookies, a tenure split not a nationality split), americas-next-top-model S09 "The China Turn" (two-city China leg, same domestic cast — already logged 2026-08-05), amazing-race S31 "Reality Showdown" (a same-country CBS-franchise alumni field — Amazing Race/Survivor/Big Brother — a `familiar-faces-wrong-franchise` fact, not a national-flag split), and survivor-australia S08 "Heroes V Villains" (a reputation-archetype split, not a nationality split, and survivor-australia is already one of this list's 9 seated shows via S11, so out of bounds regardless). Zero qualifying candidates found; every real hit is either a location-only shoot on an unchanged cast, a same-country franchise-crossover fact already homed elsewhere, or an archetype/tenure split rather than a national-line one. List holds at 9 entries / 9 shows. No `content/themes/*.md` file touched this pass; `last_revised` unchanged (no content change); `last_reviewed` re-confirmed 2026-08-21. |
...
| the-other-side-of-the-table | craft | 2026-08-06 | 2026-08-06 | extended 2026-08-01 (10→11 entries, 8→9 shows). Content-curator tick: exhaustive brand-new-list search first (checked ~15 candidate shows for saturation — vanderpump-rules, below-deck-mediterranean, below-deck-sailing-yacht, 90-day-fiance, big-brother, queer-eye, bake-off, dragrace-uk, hells-kitchen, naked-and-afraid, alone variants, love-is-blind, too-hot-to-handle, survivor-australia — and ~10 keyword sweeps: clip shows, spin-off backdoor pilots, weather-forced production changes, supersized episodes, results-show splits, calendar containment, All-Star mentor mechanics; every angle either already claimed, too thin for the 3-show floor, or converged on this exact list's thesis). Survivor S39 "Island of the Idols" entry, rank 2 — the season's own `format_changes: [mentor-island-twist]` and lede state plainly "two returning legends set up on a separate beach, coaching new players who visit one at a time," a direct match for this list's winner-crosses-to-the-mentor's-side thesis. Confirmed via a full `show: survivor` grep across every `content/themes/*.md` that S39 had zero prior ledger appearances at all — the season was entirely unclaimed. Inserted at rank 2, directly behind the Voice's Kelly Clarkson entry — S39 stakes its whole season premise on the mechanic (comparable to Ink Master S10/S12 and Big Brother S14, the list's other full-season-built-around-it entries) rather than a single personnel change, so it outranks the singular-hire entries below it. Existing ranks 2–10 shifted to 3–11. Considered and rejected shipping a brand-new "contestant becomes authority figure" list instead of extending this one: the concept is this list's exact thesis, confirmed already flagged as fully mined territory by prior passes (`plan/LISTS.md` Ideas log, pass 8 and pass 18 both cite this list's "alumni-authority" angle as claimed). List now runs 11 entries across 9 shows, no show over 2 (ink-master and bachelorette both hold 2, the informal per-show cap for this list is respected). Extended again 2026-08-06 (Rule 3 tick, extend-first strategy: reviewed and rejected `someone-else-held-the-chair-for-a-while`, `the-host-never-walks-into-the-room`, and `the-countdown-doesnt-negotiate` first — all either fully saturated at their per-show cap or every promising candidate season already staked elsewhere in the ledger, including Drag Race UK S04, Shark Tank S09, Big Brother S26, Chopped S49, and American Ninja Warrior S12, each confirmed claimed via full-ledger grep before rejection). MasterChef Australia S16 "Four Voices" entry, rank 12 — the season's own `watch_list` states plainly "Poh's move from contestant to judge brings a different perspective to the panel — she's evaluated by this format before," a direct, textually-sourced match for this list's contestant-crosses-to-the-judge's-side thesis, distinct from the S10 entry already on this list (guest audition-round judging by a slate of past winners, not a permanent panel seat won by a former contestant). Confirmed via a full `show: masterchef-australia` grep across every `content/themes/*.md` (43 prior appearances checked) that no other list stakes Poh Ling Yeow's contestant-to-judge crossover specifically — the nearest neighbor, `someone-else-held-the-chair-for-a-while` rank 9, claims the same season but a different fact entirely (Jamie Oliver/Rick Stein returning as guest judges against the newly-expanded four-seat panel), and a supplementary `Poh` grep across the full themes directory returned only one unrelated hit (`same-license-different-rules`, a roster-list mention with no crossover framing). Appended at rank 12 (bottom of list, no editorial case for a higher slot — a single new judge seat is a smaller structural bet than the full-season mechanics ranked above it). List now runs 12 entries across 9 shows; masterchef-australia moves to 2 of 12, still under the informal per-show cap. |
| when-the-crew-stepped-into-frame | craft | 2026-08-06 | 2026-08-06 | **extended 2026-08-06** (content-curator tick, ninth Rule-3 pass today: Rule 2 season-fill re-confirmed stalled per `plan/CADENCE.md`'s fully-starred gap table — next sweep due 2026-08-09 — fell through to Rule 3; review batch re-confirmed empty, oldest `last_reviewed` still `survivor-pillars` at 2026-07-31). 10→11 entries, shows unchanged at 9 (love-island-us now 2/11). Love Island US S08 "Fiji 2026" entry, inserted rank 8 directly below the S07 entry (existing ranks 8-10 shifted to 9-11) — the season's own body text states plainly the season "repeats a pattern from the one before it: two islanders are removed over resurfaced posts, echoing last summer's own casting stumble," with the Ep 19 watch_list entry framing it as "the same story that shadowed the season before this one, now playing out again in real time and on record" — a materially different claim from the S07 entry already on this list (a single vetting failure) since S08 stakes the *recurrence itself*, the second consecutive summer the same failure resurfaces, read on its own terms as a pattern rather than a one-off. Confirmed via a full `show: love-island-us` grep across every `content/themes/*.md` that S08's five other ledger appearances (`the-cast-outgrew-the-format` rank 5, cast-size fact; `it-took-five-seasons-to-find-a-home` rank 8, format-stability-at-scale fact; `a-way-back-in` rank 9, vote-reversal-mechanic fact; `never-starts-cold` rank 3, premiere-heat fact; `live-without-a-net` rank 11, Casa Amor live-unedited-feed fact) all stake facts distinct from the recurring-vetting-failure claim staked here. List now runs 11 entries across 9 shows, no show over 3 (alone still holds 2, love-island-us now 2). — previously extended 2026-08-05 (9→10 entries, 8→9 shows). Love Island US S07 "Fiji 2025" entry, inserted rank 7 (directly after the Bachelor in Paradise S03 disciplinary-removal entry, existing ranks 7-9 shifted to 8-10) — the season's own `pull` field states it's "the loudest test of its own vetting" and the Ep 3 watch_list entry frames "the villa's cast shifts unusually early after off-camera issues surface — a real-time vetting story playing out alongside the format for the first time," with the body text confirming "two islanders exit the villa days apart after old posts resurface" — a genuine casting-machinery-breaks-through moment paired naturally next to the Bachelor in Paradise entry (both stake producers directly intervening in the cast outside the normal process, rather than a medical team or rulebook clause). Confirmed via a full `show: love-island-us` grep across all 21 theme files carrying this show that S07's four prior appearances (`the-cast-was-still-arriving` rank 5, the Casa Amor cast-volume fact; `never-starts-cold` rank 1, the premiere-heat fact; `it-took-five-seasons-to-find-a-home` rank 7, the formula-at-scale fact) never touch the vetting-failure/cast-removal fact staked here. Re-ran this list's narrow `medical|injur|withdr|tap(ped)? out|evacuat|paramedic` grep catalog-wide first and it again returned only the seasons already claimed on this list — the medical/injury vein is fully tapped out — so the new entry came from the same broader `producers (remove|step in|intervene|pull|forced|disqualif)` sweep that surfaced Bachelor in Paradise S03 last pass. Also checked and rejected as already-claimed elsewhere with a near-identical fact: Bachelor in Paradise S04 (its on-set-investigation production-halt fact is already staked at `the-schedule-didnt-ask-permission` rank 2) and Queer Eye S08 (its security-incident shoot-pause fact is already staked at `the-schedule-didnt-ask-permission` rank 3); MasterChef S11 (its mid-season production halt is already staked at `pandemic-seasons` rank 17). List now runs 10 entries across 9 shows, no show over 3 (alone still holds 2, the informal per-show cap for this list is respected). |
| built-for-one-playing-as-a-team | craft | 2026-08-10 | 2026-08-10 | **extended 2026-08-10** (content-curator tick, sixteenth same-day Rule-3 pass, extend-a-healthy-list strategy after fifteen earlier same-day zero-ship/shipped passes today exhausted fresh-concept axes — see this file's tail notes): 11→12 entries, shows unchanged at 8 (second the-challenge entry). The Challenge S41 "Vets & New Threats" entry, rank 12 — the season's own `pull` and watch_list text state its Performance Points system, mid-season Lock In, and late Stake a Claim twist keep "partner status contested from open to close" through the whole run, a direct match for this list's built-for-one-flips-to-a-team thesis; distinct from S12 Fresh Meat's simple at-the-start pairing bet, S41's partnership stays structurally renegotiable across three separate phases instead of locking in once. Confirmed via a full `show: the-challenge` grep across every `content/themes/*.md` that S41's two other ledger appearances (`familiar-faces-wrong-franchise` rank 4, staking the cross-franchise casting-pool fact; `the-elimination-round-never-keeps-its-name` rank 20, staking the three-nested-mechanic-names-inside-one-plain-title fact) each stake a materially different facet of the same season — neither touches the evolving-pairing-structure fact staked here. the-challenge now at 2/12 (informal cap unchanged), ink-master still at 3/12. — previously extended 2026-08-02 (content-curator tick, Rule-2 season-fill confirmed stalled per `plan/CADENCE.md`'s fully-starred gap table, fell through to Rule 3): first touch since creation (2026-07-19), 10→11 entries, 7→8 shows. The Challenge S12 "Fresh Meat" entry, rank 11 — the season's own `format_caption` states plainly "first paired format," with the lede/body confirming each returning veteran drafts an outside-recruit rookie and "the pairs ran missions and faced elimination as a unit" — a direct match for this list's built-for-one-flips-to-a-team thesis, and the franchise's first structural pairing bet, a season before Rivals (S21) narrows the same idea to a rivalry premise specifically. Confirmed via a full `show: the-challenge` grep across every `content/themes/*.md` that S12's sole prior ledger appearance (`the-elimination-round-never-keeps-its-name` rank 4) stakes a different fact from the same season — the elimination-round-branding thesis ("the naming instinct arrives ahead of any proof the format holds"), never the structural team-scoring bet itself. Also checked and rejected The Challenge S21 "Rivals" for this list — its own pair-architecture fact is already spent twice, at `best-returnees` rank 6 ("the pair architecture unlocks confessional texture") and `the-grudge-was-the-casting-call` rank 1, too close to a duplicate. Also checked and rejected Drag Race All Stars S01 — its "self-selected two-queen teams, joint eliminations" fact is already staked near-verbatim at `new-flags-planted-fast` rank 2 ("self-select into two-queen teams with joint eliminations") and touched again at today's `best-returnees` rank 9 addition. First `the-challenge` entry on this list; list now runs 11 entries across 8 shows, ink-master still at 3/11 (informal cap unchanged). |
...
| the-couch-kept-adding-chairs | craft | 2026-08-13 | 2026-08-13 | extended 2026-08-07 (content-curator tick, twentieth Rule-3 pass, Rule-2 season-fill confirmed stalled — nearest real finale 2026-08-09 still future, every gap-table row starred/unaired): 15→16 entries, rhoslc goes 2→3 shows-count unchanged at 9 (rhoslc already on list from S03/S04). RHOSLC S06 entry, rank 16 — the season's own file states plainly all seven full housewives from the year before return with "no new departures from the core group," calling it "the most cast-stable season RHOSLC has run" (lede) and "Seven full housewives, fully retained" (cast_size_caption); confirmed via full `show: rhoslc` grep across every `content/themes/*.md` that season 6 carries zero prior ledger appearances (existing rhoslc stakes: S01 x2, S02, S03 x2, S04, S05 — never S06). Framed as the list's inverse case: every other entry stakes a swing, this one stakes the season the roster finally held still, directly contrasting the show's own S03/S04 entries already on this list (steepest contraction, then steepest rebuild) two ranks up. rhoslc now holds 3 entries, the list's most-represented show, at but not over the informal 3-per-show cap seen elsewhere (amazing-race, top-chef). Considered and rejected first: re-extending `one-season-two-flags` (reconfirmed dead per its own 2026-08-05 note, an independent ~30-file sweep already found zero groundable entries and none of today's newly-read season files changed that); seven single-show lists checked and confirmed capped at their show's full aired-season count (some-seasons-rebuild-the-roster-others-just-move-the-furniture/Selling Sunset 9-of-9, it-took-five-seasons-to-find-a-home/Love Island US 8-of-8, the-wait-between-seasons-was-never-the-same-twice/RHOM 7-of-7, every-season-strikes-a-different-bargain-with-lana/Too Hot to Handle 6-of-6, seven-ways-to-break-the-same-app/The Circle 7-of-7, the-series-the-uk-edition-finally-made-its-own/Drag Race UK 7-of-7, home-seasons-waited-relocation-seasons-didnt/Jersey Shore 6-of-6, new-house-rules-every-time-the-castle-reopens/Traitors UK 4-of-4); Below Deck Sailing Yacht S04 (Sardinia) considered for `the-place-fought-back` but rejected — the season file's own language ("proof of the register," crew-authority framing) tracks too closely to the already-shipped `the-quiet-register-was-the-whole-point-until-ibiza` entry for the same season, near-duplicate risk. Excluded per this tick's constraints: `best-post-merge` (nineteenth pass, same day), `someone-else-held-the-chair-for-a-while` (eighteenth pass, same day), `running-on-muscle-memory` (seventeenth pass, same day), and all `the-voice` seasons numbered 22+ (open [HIGH] factual-corruption finding, plan/AUDIT.md line 624). **extended 2026-08-13** (content-curator tick, Rule-2 season-fill confirmed stalled per `plan/CADENCE.md`'s fully-starred gap table; the day's `one-rule-fills-every-seat` extend already shipped before this pass, so this tick targeted a different list): 16→17 entries, rhom 2→3 shows-count unchanged at 9 (rhom already on the list from S02/S03). RHOM S07 entry, rank 6 — the season's own file states plainly Stephanie Shojaee joins the main cast the same season "Nicole Martin steps back to a guest role after four years full-time" (paraphrasing the lede's "Nicole Martin steps down to guest status after four seasons as a full-timer"), with `cast_size` holding flat at six before and after — a direct match for this list's cast-swing thesis, and a materially different shape from rhom's own two existing entries here (S03's steep post-finale contraction to five; S02's "flat headcount hides a four-person overhaul" upheaval) — S07 is a clean one-for-one handoff, the smallest-magnitude swing rhom has produced, not another version of S02's "flat number hides a bigger story" trick. Confirmed via a full `show: rhom` grep across every `content/themes/*.md` that S07's two other ledger appearances (`two-channels-same-night` rank 10, staking the Peacock same-day-to-next-day release-gap fact; `the-wait-between-seasons-was-never-the-same-twice` rank 2, staking the nineteen-month premiere-gap fact) never touch the cast swap itself. Considered and rejected first: RHOM S06 (own file states the "core revival cast returns intact," a stability fact with nothing to stake for a swing-focused list, and its Bravo-linear-return fact is already spent at `two-channels-same-night` rank 3); a second RHOSLC entry beyond the existing three (S05's "fullest roster yet" fact is already staked near-verbatim at the show's own single-show list `four-names-never-leave-the-credits` rank 4 — "Mary Cosby is promoted back to full housewife status and Bronwyn Newport joins as new full-time cast, pushing the group to seven full housewives, the biggest roster yet" — too close to a direct duplicate to restake here); a second RHOBH entry (the show's cast-composition story is already the dedicated province of its own single-show list, `the-friend-credit-became-the-farm-system`, all fifteen seasons mapped — restaking any RHOBH cast swing here would shadow that list rather than add a new angle); a second RHOC entry (RHOC's full cast-churn history is likewise the dedicated province of its own single-show list, `the-founding-five-kept-getting-replaced`, at 19 entries). List now runs 17 entries across 9 shows, none over the informal 3-per-show cap (rhoslc and rhom both now at 3/17). |
...
| twice-in-one-year | era | 2026-08-21 | 2026-08-21 | extended 2026-07-31 (14→15 entries, 4→5 shows). Big Brother S09 "The Winter Couples" entry, rank 8 — the season's own file states plainly it's "the only Big Brother season to air in winter," premiering February 12, 2008, five months ahead of that year's regular summer edition (S10, July 13, 2008; premiere dates confirmed via both seasons' own frontmatter), a genuine calendar-pace match for this list's twice-in-a-year thesis distinct from every other show already on the list (ANTM, DWTS, Project Runway, So You Think You Can Dance). Confirmed via a full `show: big-brother` grep across every `content/themes/*.md` that S09's four prior ledger appearances (`built-for-one-playing-as-a-team` — couples-team-structure fact; `every-summer-gets-its-own-twist` — twist-history fact; `when-scripted-went-dark` and `the-schedule-didnt-ask-permission` — both staking the writers'-strike-as-cause fact; `tried-once-never-repeated` — the one-off-swing fact) each stake a materially different angle from this list's pure calendar-pacing claim; the blurb here deliberately doesn't restate the strike as its primary thesis (already spent twice) and instead frames the fact as "the only year this house... runs twice." Inserted at rank 8, directly below Project Runway S03 (2006) and above So You Think You Can Dance S05 (2009) — chronologically correct for the list's year-ordered structure. Existing ranks 8-14 shifted to 9-15. List now runs 15 entries across 5 shows. **extended 2026-08-21 (Rule 3 tick, content-curator, sixty-eighth-plus pass — dispatched after six same-day zero-ship passes on this exact ledger had already exhausted casting/hosting/licensing/vote-authority/reward-structure/headcount angles, see the final Ideas-log entries dated 2026-08-21): 15→17 entries, 5→6 shows, Amazing Race added.** Amazing Race S02, rank 1 — the season's own file states its premiere date (2002-03-11) and its widened casting brief ("sibling pairs, dating couples") in `content/shows/amazing-race/seasons/02-season-2.md`; S03, rank 2 — that season's own file gives premiere date 2002-10-02 and the twelve-team cast expansion (`format_changes: [twelve-team-cast]`, "Twelve teams started from Miami"). Cross-checked both seasons' `premiere_date` fields against every other early-Race season file (S01 2001-09-05, S04 2003-05-29) to confirm S02+S03 are the *only* same-calendar-year Race pair, landing in 2002 — a full year earlier than the list's previous earliest entry (ANTM S01, May 2003), so `era_range` moves from `[2003, 2013]` to `[2002, 2013]` and the two new entries insert at rank 1-2 (existing 15 entries shift +2, ranks 3-17). Confirmed via a full `show: amazing-race` grep across every `content/themes/*.md`: S03 had zero prior ledger appearances; S02's one prior appearance (`when-the-cast-was-already-related`, sibling-team casting fact) stakes a different angle than the calendar-pace fact staked here, so no duplicate. Because the new pair now predates ANTM S01, ANTM S01's existing blurb (which read "No other show in this catalog had tried that pace yet; this is where it starts") was no longer accurate and was edited in place to drop the now-false primacy claim, replaced with "The modeling format catches a pace only a handful of competition shows would keep up for the rest of the decade" — title and rank untouched, only the superlative clause corrected. No other ledger row touched. Considered and rejected before landing here (same pass): a MasterChef (US) S11 "Legends" entry for `the-schedule-didnt-ask-permission` (the season's own lede states filming "was filmed before the pandemic, halted, and completed over a year later," but that exact fact is already staked near-verbatim at `pandemic-seasons` rank 17, "Filming halts mid-season and resumes more than a year later"); a Bake Off S12 "The Second Bubble" entry for `pandemic-seasons` (the season's own `pull` states "the bubble premise stops being a novelty and starts being a constraint," but that exact second-bubble-loses-its-novelty fact is already staked at the single-show list `the-tent-moved-more-than-the-show-admits` rank 8, "The same sealed hotel, with none of the first year's novelty"). |
...
| the-finals-never-run-the-same-course-twice | single | 2026-08-07 | 2026-08-07 | extended 2026-08-07 (content-curator tick, twenty-second Rule-3 pass, Rule-2 season-fill confirmed stalled per `plan/CADENCE.md`'s fully-starred gap table; a same-day earlier Rule-3 pass had already zero-shipped on the tone/craft/era vein — see this file's "2026-08-07 pass (content-curator tick): zero-ship" Ideas note — so this pass pivoted to the never-touched-since-creation `category: single` cluster from 2026-07-21/22/23 instead): 12→14 entries, first touch since creation. American Ninja Warrior has 17 filed season files against this list's then-12 entries, leaving five genuinely unchecked seasons (S03, S05, S07, S08, S16); read all five directly. Rejected S03 (its own file covers only the Boot Camp elimination stage and an NBC primetime replay pickup — no national-finals-course text exists in the file at all, off-thesis); rejected S08 (its own curved-course/Philadelphia-toughest-finals fact is already staked near-verbatim at `best-challenge-design` rank 11 — "Indianapolis debuts the franchise's first curved-layout design. Philadelphia's finals course lands as the toughest built to that point" — a second stake here would duplicate that entry outright); rejected S16 (its own per-stage time-limit increase is already staked verbatim at `the-countdown-doesnt-negotiate` rank 12 — "raises the per-stage time limits across all four standard stages" — and its episode-count/broadcast-length fact is a different list's thesis entirely, staked at `running-long-running-short` rank 7). Shipped two clean, distinct entries. S07 "Military Appreciation" entry, new rank 10 (inserted directly below S10, S06/S05[new]/S01/S14 each shifted +1 to +2) — the season's own body text states plainly "Stage one adds the Sonic Curve, Coin Flip, and Triple Swing; stage three gets the Psycho Chainsaw and Area 51," a genuine finals-course-obstacle-overhaul fact distinct from S07's three other ledger appearances (`when-the-reward-pointed-somewhere-else` rank 6 stakes the USS Iowa qualifying-stop tribute fact; `never-needed-a-villain` rank 16 stakes the battleship-tribute cast-warmth fact; `same-crown-new-price-tag` rank 14 stakes the $1M grand-prize-doubling fact) — confirmed via a full `show: american-ninja-warrior` grep across every `content/themes/*.md` that none of the three touches the Stage 1/Stage 3 obstacle swap. S05 entry, new rank 12 (directly below S06, above S01) — the season's own lede/body states nationals return "to Las Vegas for a second straight year" with the Rope Glider joining qualifying and the Hang Slider debuting "on the national stage," framed here as the finals course's first post-launch refresh rather than a repeat of S04's founding swing; S05's only other ledger appearance (`season-one-doesnt-own-every-first` rank 12) stakes the first-woman-clears-the-Warped-Wall milestone as its primary claim, mentioning the same two obstacles only as supporting texture, so the fresh entry's primary claim (course continuity + refresh) is materially distinct. List now runs 14 entries, still 1 show (single-show list, no cross-canon floor); three american-ninja-warrior seasons remain unclaimed on this list (S03 off-thesis, S08 and S16 both fully duplicate elsewhere) — effectively tapped out barring a future onboarded season. |
...
| when-scripted-went-dark | era | 2026-08-21 | 2026-08-21 | extended 2026-08-21 (Rule-3 pass, content-curator tick, Rule 2 confirmed stalled per `plan/CADENCE.md`'s fully-starred gap table; reached this row after all seven of today's earlier passes zero-shipped elsewhere): 14→16 entries, 13→14 shows. Project Runway S20 "New York" entry, rank 15 — premiere_date confirmed June 15, 2023, six weeks into the WGA walkout (May 2–Sep 27, 2023), and the season's own file states plainly it's an all-returning-designers cycle running "no single host — mentor and judges carry the season instead," a strike-window date paired with a texture (no-host structure) genuinely distinct from this list's existing Project Runway S04 entry (rank 2, a strongest-cast fact, not a hosting-structure fact). Love Island US S05 entry, rank 16 — premiere_date confirmed July 18, 2023, four days into the SAG-AFTRA strike that joined the still-running WGA walkout, and the season's own file frames it as the daily-drop Peacock format "settling into a confident, repeatable groove" — the list's first Love Island US entry, a new show for this row. Both confirmed non-duplicative via full `show: project-runway` and `show: love-island-us` greps across every `content/themes/*.md`: Project Runway S20 had zero prior ledger appearances anywhere; Love Island US S05 had zero prior ledger appearances anywhere. Reconsidered The Challenge S39 (premiere_date October 25, 2023, inside the same SAG-AFTRA window) as a third addition — drafted, then reverted after re-reading this row's own 2026-08-07 note above, which had already rejected S39 for this list as duplicative of its no-rookies/never-won-veterans fact, independently staked at `the-elimination-round-never-keeps-its-name` rank 18 and referenced again at `the-cold-open-then-never-again` rank 10; re-confirmed via a fresh `season: 39` grep across `content/themes/*.md` that both stakes still hold, so the season was left off rather than restaking a claimed fact. Also considered and rejected as thin or off-thesis: Too Hot to Handle S05 (premiere_date July 14, 2023, the exact SAG-AFTRA start date, but already staked three times elsewhere — `the-cast-was-still-arriving`, `the-turnaround-skipped-a-year`, `built-for-the-drop` — with no distinct strike-window texture left to add); MasterChef Australia S15 (an Australian Network Ten production with no tie to a US labor stoppage, and a real-world tribute-season context unsuited to this list's premise, same thematic-mismatch reasoning as the earlier-rejected Bake Off S14); 90 Day Fiancé S10 (its two distinguishing textures — crossover casting, episode-count record — already staked at `the-franchise-started-borrowing-from-itself` and `not-the-usual-order`); Bachelorette S20 (its shortest-modern-run fact already staked verbatim at `the-format-kept-moving-the-furniture` rank 14). Inserted at ranks 15-16, after the existing rank-14 Below Deck Mediterranean capstone entry, in chronological order relative to each other (Project Runway S20 June 15 before Love Island US S05 July 18). List now runs 16 entries across 14 shows, no show over 2. |
...
| the-command-held-for-ten-seasons-then-didnt | single | 2026-08-11 | 2026-08-11 | **renamed 2026-08-11** (cloud march tick, CRITIQUE pass-112 HIGH fix): slug was `the-command-held-for-nine-seasons-then-didnt` — the 2026-08-10 extend below updated the title/description/body to "ten of eleven" but deliberately left the slug untouched, reasoning it was like a stable season slug; CRITIQUE correctly flagged that reasoning as wrong for this file, since the slug's spelled-out "nine-seasons" is itself a factual claim, not an arbitrary handle, and it now contradicted the page's own title. Renamed the file, added a permanent 308 in `src/middleware.ts` from the old path, updated the two sibling `related:` references (`two-coasts-one-open-call`, `the-masks-changed-every-week-the-panel-never-did`). No entry/ranking change. **extended 2026-08-10** (content-curator tick, twentieth same-day Rule-3 pass): 10→11 entries, reopened after being logged "maxed-out" at 10/10 seasons on 2026-08-03 — Below Deck Mediterranean S11 "Dubrovnik II" landed today (already staked once today at `been-here-before` rank 6 for its location-return/new-yacht/new-chef/rebuilt-crew facts). This list's own thesis is narrower than that fact set — Captain Sandy's command authority specifically — and the season's own `host_caption` states plainly it's "Captain Sandy Yawn's third season with this crew nucleus, back in Dubrovnik," a fact `been-here-before`'s entry never uses (that entry frames the location's pull and the rebuilt room; this one frames the *command's* multi-season continuity with its closest crew against an otherwise new room). The show's own canon.md entry for S11 independently confirms the angle: "the cast case is still unproven this early... where this one lands long-term depends on chemistry the record doesn't have yet" — the honest-middle placement (new rank 9, between S08 and S01) tracks that verdict. Confirmed via a full `show: below-deck-mediterranean` grep across every `content/themes/*.md` that S11's only other ledger appearance is the `been-here-before` entry noted above — no third list touches this season. Title/description/tagline updated throughout to replace the stale "nine of ten seasons" framing with "ten of eleven" (S11 is Sandy-led, so the exception count — Season 3's João Franco run — stays at one; only the total season count changed). Slug/filename left untouched (stable URL) despite the title's number changing, consistent with how season slugs stay fixed under evolving display copy elsewhere in the schema. Entries 9-10 (formerly S01 rank 9, S04 rank 10) shifted to ranks 10-11 to make room. `related` untouched (still `the-charter-map-as-the-whole-story`, `the-mic-changed-hands`). List now 11/11 aired Below Deck Mediterranean seasons — maxed-out again, will need a twelfth aired season to reopen.  **description trimmed 2026-08-11** (cloud march tick, CRITIQUE pass-112 SEO-truncation fix): description field cut to end at a natural clause boundary within the ~155-160 char SERP budget (see CRITIQUE.md resolution for exact before/after text). No entry/ranking change. |
| running-on-muscle-memory | tone | 2026-08-09 | 2026-08-09 | extended 2026-08-09 (content-curator tick, forty-eighth pass in today's sequence): Rule 2 re-confirmed stalled (`plan/CADENCE.md`'s gap table still fully starred/confirmed-but-unaired) and no ledger row 90-day review-due (oldest `last_reviewed` still `survivor-pillars` at 2026-07-31) — fell through to Rule 3. Read `content/shows/masterchef-australia/seasons/18-open-call.md` directly (landed 2026-08-09, the newest season in the catalog, already staked once this same day at `the-open-call-built-the-format` rank 14 for its returning-on-air-auditions fact per the 93rd pass) looking for a second, genuinely distinct stakeable fact. Found one: the season's own `eyebrow`/`lede`/`pull`/watch_list text states plainly the panel "enters its third season unchanged," calling it "the format's longest-serving lineup without a single swap" and framing the whole season as "run by a panel that no longer needs to find its footing." That is a direct, unhedged match for this list's settled-panel/no-reinvention-needed thesis — the same shape as the existing MAFS Australia S09 and The Voice S25 entries — and a materially different fact from the open-call-mechanic-returns claim already staked at rank 14 (that entry stakes the audition *format*; this one stakes the judging *panel's* tenure). Confirmed via a full `show: masterchef-australia` grep across every `content/themes/*.md` that S18's only prior appearance is `the-open-call-built-the-format` rank 14 — no other list touches the panel-stability fact. 20→21 entries, first masterchef-australia entry on this list (distinct from the existing masterchef (US) S03/S04 entries — different show slug, different franchise). Appended at rank 21 (bottom), matching this list's own established append-at-the-tail precedent for its most recently landed seasons. — previously extended 2026-08-06, seventeenth Rule-3 pass (The Voice S25 "The Anchor" entry, rank 20 — the season's own lede/pull/body state plainly the panel "was stable and experienced, with enough overlap from recent seasons to run smoothly if without the friction a debut generates," calling the season "settled, competent, a degree below urgent" and describing a coaching panel that "ran on experience... no debut urgency, no structural novelty, just a well-assembled coaching panel doing the job" — a direct thesis match; confirmed via a full `show: the-voice` grep across every `content/themes/*.md` that S25 had zero prior ledger appearances anywhere at this exact season (S25/S22 were surfaced and explicitly rejected earlier the same day for `the-panel-turned-over-more-than-the-contestants-did`'s turnover thesis — the opposite shape, confirming this settled-panel fact was unclaimed); eleventh distinct show on this list, first The Voice entry); previously extended 2026-08-03 (Alone Australia S3 "West Coast Range" entry, rank 18 — the season's own body text states plainly "the production team handles the self-filmed footage more confidently," citing a tighter edit rhythm and a deepened Australian cast pool, and frames the season as one that "consolidates rather than expands the format's range" in the canon write-up — a direct match for this list's execution-not-reinvention thesis; confirmed via a full `show: alone-australia` + `season: 3` grep across every `content/themes/*.md` that this season's two prior ledger appearances (`the-place-fought-back` rank 7, staking the sustained-rainfall/terrain-as-antagonist fact, and `one-rule-never-bends` rank 9, staking the no-format-rule-changed fact) never stake the production/execution-confidence claim as their own central thesis; ninth distinct show on this list, first alone-australia entry); previously extended 2026-08-02 (Married at First Sight Australia S09 entry, rank 17 — the season's own file states plainly it runs "at its most settled," with the Aiken–Schilling–Rampolla panel in its second year together, eleven couples at franchise-standard scale, and "no new structural twist," proving the format doesn't need novelty now that the panel and cast rhythm have bedded in; confirmed via a full `show: married-at-first-sight-australia` grep across every `content/themes/*.md` that S09's two other ledger appearances — `the-episode-order-never-found-its-ceiling` rank 6 (an episode-count record fact) and `the-reshuffle-stays-in-house` rank 8 (a returning-participant recasting fact) — never touch the settled-panel/no-new-mechanic tone claim staked here; eighth distinct show on this list, first MAFS Australia entry); previously extended 2026-07-29, second pass same day (Traitors UK S04 "Series 4 (2026)" entry, rank 16 — the season's own lede/watch_list frames a fourth run at the same Ardross Castle as leaning "into the format's own mythology rather than reinventing it," with a cast that's "clearly watched the earlier series" and a game that "barely needs explaining anymore," a direct thesis match distinct from S04's two existing ledger appearances (`the-broadcast-wasnt-the-whole-show` rank 7, `new-house-rules-every-time-the-castle-reopens` rank 3), both of which center the Uncloaked companion-show/spinoff fact rather than the core game-and-host confidence claim; seventh distinct show on this list, first traitors-uk entry, distinct from the existing Traitors US S04 entry at rank 15); previously extended 2026-07-29 (Traitors US S04 "Season 4 (2026)" entry — a freshly-drained season, premiered Jan 2026, its own text stating "no reinvention here... a confident, repeatable machine," a direct match for this list's thesis; zero prior appearances anywhere in the ledger, first Traitors entry on this list, sixth show); previously extended 2026-07-28 (American Idol S14 "The Quiet Year" entry — the season's own text names the exact "muscle memory" phrase; zero prior appearances anywhere in the ledger); extended again 2026-08-03, hundredth pass (The Ultimatum S03 entry, rank 19 — the season's own lede states plainly the premise "doesn't need to prove itself" three seasons in, with the format now "a known quantity" and the pull framing the whole season as a test of whether "a new cast's own history" can make a familiar deadline sting again — a direct match for this list's execution-not-reinvention thesis; confirmed via a full `show: the-ultimatum` grep across every `content/themes/*.md` that S03 had zero prior ledger appearances anywhere — its sibling seasons are staked at `built-for-the-drop` (S01), `the-hand-behind-the-couple` (S01), `missing-on-purpose` (S01), `best-premieres` (S01), `proving-the-debut-wasnt-luck` (S02), and `season-one-doesnt-own-every-first` (S04), none touching S03; thirteenth distinct show on this list, first the-ultimatum entry, appended at the bottom rather than rebased since its cast-history framing reads as a marginally more hedged fit than the pure-execution top tier) |
...
| the-company-upstairs-changed-hands | era | 2026-08-08 | 2026-08-08 | extended 2026-08-08 (cloud march tick, thirty-eighth Rule-3 pass, content-curator): 13→16 entries, 10→12 shows, `era_range` widened [2006,2022]→[2006,2025]. Landed a genuinely fresh anchor event this list had never used: Paramount Global's real-world merger with Skydance Media, which closed August 7, 2025, forming Paramount Skydance Corporation — confirmed via a full-corpus grep that no existing theme file mentions "Skydance" or "Paramount Global" anywhere, so the event was entirely unstaked. Three new entries anchor to it: Survivor S49 (rank 14, own `premiere_date` 2025-09-24, ~7 weeks after close), Amazing Race S38 (rank 15, own `premiere_date` 2025-09-25, exactly 7 weeks after close, one day after S49 — deliberately paired the same way this list already pairs BB S07/Survivor S13/TAR S10 for the 2006 CBS split), and Ink Master S17 "Hometown Heroes" (rank 16, own `premiere_date` 2025-10-29, ~12 weeks after close, the list's first Paramount Network entry as distinct from CBS/MTV). Confirmed via per-show `show: <slug>` greps across every `content/themes/*.md` that Survivor S49 has zero prior ledger appearances anywhere (a genuinely untouched season); Amazing Race S38 and Ink Master S17 both carry several prior appearances (`the-roster-was-the-twist`, `best-challenge-design`, `every-season-split-the-room-differently`, `the-team-rule-never-makes-it-to-a-second-season`, `best-finales`, `the-judging-table-never-got-to-coast`) but every one stakes a roster/challenge-design/format-structure/finale fact, none touching corporate-ownership timing, matching this list's own established precedent of restaking multiply-claimed seasons (Top Chef S09 alone already appears in a dozen-plus other lists). `description` updated to add the new merger to its enumeration (260 chars, under the 280 cap); `status` bumped started→growing to reflect the reopened cadence. Shortlisted this row as one of the coldest, least-mined rows in the ledger (untouched since creation 2026-07-23, zero prior pass-note history anywhere in this file). RHOM S01 entry, new rank 4 (ranks 4-12 rebased to 5-13 to hold the list's chronological order) — the season's own `premiere_date` frontmatter (2011-02-22) lands just twenty-five days after Comcast's acquisition of NBCUniversal formally closed (January 28, 2011, the same well-established public-record anchor event this list's existing Voice S01/AGT S06/Top Chef S09 entries already use), the tightest turnaround of any entry on the list; the season's own file supplies the "real story" clause (six-woman founding Miami cast, Bravo's first South Florida shoot). Confirmed via a full `show: rhom` grep across every `content/themes/*.md` that S01's three prior ledger appearances (`new-flags-planted-fast`, `wealth-as-the-whole-pitch`, `best-newbie-casts`) stake founding-cast/wealth-pitch/newbie-casting facts, none touching the corporate-ownership-timing angle staked here. Considered and rejected before landing on RHOM: `someone-else-held-the-chair-for-a-while` (craft, also cold, extensively chased first — Drag Race UK S04's Michelle Visage-covers-RuPaul fact is already staked near-verbatim at `season-one-doesnt-own-every-first` rank 11; Shark Tank S09's guest-shark-covers-O'Leary's-absence fact is already staked near-verbatim at the single-show list `the-extra-seat-is-never-a-swap` rank 5; Ink Master S15's Dave Navarro absence has no named replacement filling his specific chair, off-thesis; AGT S17 has no season-file text grounding a Cowell-absence/guest-judge fact — zero-ship on this list this pass); `the-host-never-walks-into-the-room` (craft, fully cold, zero pass-note history) — all four shows already on the list (too-hot-to-handle, love-island-uk, love-island-us, the-circle) sit at the 3-per-show craft cap, and no fifth show's season file grounds a genuine disembodied-host-authority fact (Perfect Match's Nick Lachey is a standard on-camera host per every season file read) — not pursued further. |
...
| someone-else-held-the-chair-for-a-while | craft | 2026-08-11 | 2026-08-11 | extended 2026-08-07 (eighteenth Rule-3 pass, content-curator tick, Rule 2 confirmed stalled per `plan/CADENCE.md`'s fully-starred gap table, next sweep due 2026-08-09): 10→11 entries, 8 shows unchanged (masterchef now 2/11). MasterChef S10 "The Milestone" entry, rank 11 — the season's own file states plainly "Ramsay, Sanchez, and Bastianich are a settled panel" while "guest judges Grant Achatz and Masaharu Morimoto raise the culinary stakes" for the tenth-anniversary run — a direct match for this list's no-vacancy/guest-chair-as-occasion sub-thesis already established at this list's own shark-tank S07 rank-7 entry ("the guest chair stops meaning someone's away"), but a genuinely distinct fact from it (named guest chefs added for a milestone, not a permanent seat). Confirmed via a full `show: masterchef` grep across every `content/themes/*.md` that S10's two other ledger appearances — `milestones-spent-not-marked` rank 8 (Battle Pass mechanic + first international field challenges) and `the-advantage-was-never-free` rank 7 (the Battle Pass advantage-stacking mechanic itself, whose own blurb explicitly closes "not just the guest list" — confirming the guest-judge fact was deliberately left unstaked there) — both stake the Battle Pass/international-expansion facts, never the guest-judge fact staked here. Zero prior appearances anywhere in the ledger for "Achatz" or "Morimoto" (full-catalog grep). Distinct from this list's own existing MasterChef S11 rank-8 entry (a full-season weekly-rotating-guest-as-format-premise fact) — S10's guests appear for specific milestone episodes alongside an otherwise untouched panel, a materially different duration and premise. Considered and rejected first: Top Chef S06 "Las Vegas" (its own file's "joined by guest judges who treated the food seriously" line is too generic — no named guest, no vacancy or occasion framing, reads as scene-setting rather than a staked fact); Dancing with the Stars, Ink Master, and Drag Race (main) — grepped all three shows' season files for "guest judge"/"fills in"/"substitut" language, zero hits, no groundable candidate without a scout pass; RHOBH S09 "The Rotation" and S13 "The Fracture" — read in full, both center newcomer-arrival/location facts, not a judge-or-host vacancy; Vanderpump Rules seasons 3, 5, 6 — read in full, all center cast-scaling/ensemble-growth facts with no guest-chair language at all.  **description trimmed 2026-08-11** (cloud march tick, CRITIQUE pass-105/110/112/104 SEO-truncation fix): description field cut to end at a natural clause boundary within the ~155-160 char SERP budget (see CRITIQUE.md resolution for exact before/after text). No entry/ranking change. |
...
| straight-to-camera-never-to-each-other | craft | 2026-08-11 | 2026-08-11 |  **description trimmed 2026-08-11** (cloud march tick, CRITIQUE pass-105/110/112/104 SEO-truncation fix): description field cut to end at a natural clause boundary within the ~155-160 char SERP budget (see CRITIQUE.md resolution for exact before/after text). No entry/ranking change. |
| missing-on-purpose | craft | 2026-07-25 | 2026-07-25 | |
| one-rule-never-bends | craft | 2026-08-07 | 2026-08-07 | extended 2026-08-07 (twenty-first Rule-3 pass, content-curator): 11→12 entries, shows unchanged (5 — alone, naked-and-afraid, alone-frozen, alone-the-skills-challenge, alone-australia). Alone S07 "The Arctic" entry, rank 5 (inserted between S05 Redemption's returnee-cast bend and Alone: Frozen's full prize-model break, renumbering ranks 5-11 to 6-12) — the season's own file states plainly that Colby Donaldson "joined as host without disrupting the self-filmed, no-crew-on-location core of the format," a direct, previously-unstaked test of this list's own founding-rule-survives-a-new-variable thesis (hosting, not team structure, cast makeup, prize model, or geography — the five variables the other eleven entries already cover). Confirmed via a full `show: alone$` grep across every `content/themes/*.md` that S07 has two prior appearances — `the-place-fought-back` rank 2 (stakes the environment-difficulty-ceiling fact) and `the-ten-items-are-never-the-same-ten-items` rank 3 (stakes a gear-list fact, with the host addition mentioned only as a secondary stacked detail, not the entry's primary claim) — neither stakes the hosting-addition-as-rule-test fact this entry stakes as its primary claim. Also confirmed via targeted greps of `best-hosting.md` and `the-mic-changed-hands.md` (the franchise's two natural homes for a hosting fact) that Alone appears in neither, ruling out a stronger duplicate-stake risk before drafting. Considered and rejected other candidate extensions this tick: Alone S11 "South Africa" (biome-inversion fact already staked near-verbatim in both `the-place-fought-back` rank 4 and `the-ten-items-are-never-the-same-ten-items` rank 2 — adding a third near-identical framing here would be the exact duplication risk this ledger warns against); a `the-diners-were-never-extras` extension via Top Chef S17 All-Stars L.A. (its Restaurant Wars fact is materially the same "returnee cast already knows the stakes" claim already staked at S08 All-Stars rank 6 — too close to ship as distinct) and via MasterChef Australia S09 "Japan" (Michelin-kitchen challenges are a location/travel fact, not a real-diners-served fact — wrong list, would have been a stretch). |
...
| the-season-the-audience-showed-up-all-at-once | tone | 2026-08-20 | 2026-08-20 | **blurb scaffold varied 2026-08-20** (cloud march tick, content-gap redirect — CRITIQUE pass-110): the tagline plus 3 of 12 entry blurbs (ranks 1, 9, 10) all leaned on the identical "the franchise's own [X] [cites/reaches for] first" personification device — rewrote ranks 1 (american-idol S05), 9 (the-voice S04), and 10 (rhoa S05) to state each ratings/audience claim directly, each with a distinct sentence shape, preserving every existing factual claim (no new numbers or records invented). Tagline and titles left untouched per the finding's own scoped fix note. No entry/ranking change. — **extended 2026-08-09** (content-curator tick, eighth same-day Rule-3 pass, extend-first strategy after seven earlier same-day passes exhausted fresh-concept search axes per this file's Ideas log): 11→12 entries, 9→10 shows, first summer-house entry on this list. Re-ran the ratings-record grep this list's own thesis needs (`highest-rated|most-watched|record (ratings|audience)|biggest premiere|ratings record`) across every `content/shows/**/*.md` fresh rather than trusting the 2026-08-04 hundred-and-third pass's prior negative result verbatim, since two new seasons (love-island-us S08, summer-house S10) have filed since that check. Confirmed Love Island US S08's ratings-record fact is still already spent at `never-starts-cold` rank 3 (same rejection the 2026-08-04 pass logged, re-confirmed dead). Summer House S10 "The Overhaul Summer" is new and clean: the season's own `watch_list` carries a fourth, distinct beat beyond its already-staked cast-overhaul and reunion-format facts — "Reception · a record audience," stating plainly "the season's reunion draws the largest same-day audience in the show's history" — a direct match for this list's premiere-record/ratings-high thesis. Confirmed via a full `show: summer-house` grep across every `content/themes/*.md` that S10's two other ledger appearances (`the-roster-never-held-still` rank 1, staking the six-new-members cast-overhaul headcount fact; `the-reunion-kept-changing-its-own-rules` rank 7, staking the one-episode-to-three-parts reunion-structure fact) each stake a materially different facet of the same season — neither touches the audience-response/ratings fact staked here. `season_label` kept bare "S10" (no marketed-subtitle suffix), matching the same season's own bare-label precedent already set at `the-roster-never-held-still` — "The Overhaul Summer" reads as this site's own editorial nickname for the cast-turnover story, not a network-marketed subtitle, so the header-slot marketed-title rule calls for the bare form. No per-show cap crossed — american-idol and love-island-uk remain at 2/12 each (unchanged), summer-house now at 1/12. List now runs 12 entries across 10 shows, still well under the 24-entry cap.  **description trimmed 2026-08-11** (cloud march tick, CRITIQUE pass-105/110/112/104 SEO-truncation fix): description field cut to end at a natural clause boundary within the ~155-160 char SERP budget (see CRITIQUE.md resolution for exact before/after text). No entry/ranking change. |
| the-open-call-built-the-format | craft | 2026-08-09 | 2026-08-09 | 92nd pass: +MasterChef Australia S01 at rank 12 (12→13 entries, 5→6 shows) — nationwide audition search + three-judge panel with no local playbook, grounded in the season's own lede/body; shifted AGT S01 to rank 13. 93rd pass (2026-08-09, content-curator tick): +MasterChef Australia S18 "Open Call" appended at rank 14 (13→14 entries, still 6 shows) — the season's own frontmatter states plainly that "season eighteen brings on-air auditions back for the first time since series thirteen, narrowing forty hopefuls to twenty-four contestants," a returning-mechanic fact deliberately staked distinct from the S01 entry at rank 12, which stakes a from-scratch-invention fact (a nationwide search built with no local playbook to borrow from). The two masterchef-australia entries now argue opposite sides of the same tryout-stage thesis: S01 invented the audition funnel, S18 revives a piece of it after a five-season absence. Confirmed via a full `masterchef-australia` grep across every `content/themes/*.md` file that S18 had zero prior appearances anywhere in the ledger before this tick — first stake for the season. season_label set to "S18 · Open Call," matching the season file's own frontmatter `title` exactly (a marketed subtitle, not an in-season alliance/outcome nickname, so it's safe to quote in the header slot per the themed-list header-slot rule). |
...
| four-names-never-leave-the-credits | single | 2026-08-07 | 2026-08-07 | new list 2026-08-07 (content-curator tick, twenty-eighth Rule-3 pass, Rule-2 season-fill confirmed stalled per `plan/CADENCE.md`'s fully-starred gap table — fell through to Rule 3; fresh angle this pass: census of the 68-show catalog for shows carrying zero `category: single` list at all — alone-australia, alone-frozen, alone-the-skills-challenge, below-deck-adventure, below-deck-down-under, perfect-match, rhod, rhodubai, rhoslc, the-ultimatum, traitors all came back empty. Read all 6 rhoslc season files directly; each carries specific cast-size, episode-count, and cast-status frontmatter/body detail — Jennie Nguyen's S02 addition, the S03 contraction to a four-woman core, S04's two-housewife rebuild plus Mary Cosby's reduced friend-of return, S05's Cosby promotion + Bronwyn Newport addition + a new friends-of tier, S06's full-cast zero-departure retention — dense enough to ground 10 distinct entries, well under the ~40% overlap threshold against any single existing ledger row (the closest sibling, `the-couch-kept-adding-chairs`, only carries 2 of its 16 entries from rhoslc). 10 entries, 1 show (single-show list, no cross-canon floor). Anchored on the season-three file's own claim that only four housewives — Barlow, Gay, Marks, Rose — have appeared in every season filmed; tracks the cast-size/episode-count swing around that fixed core across all six seasons. One fact not staked anywhere else in the ledger: the episode count holds at nineteen for three straight seasons (S04–S06), surfaced here for the first time. the-ultimatum (4 seasons, S04 just landed this week) not checked further this tick since rhoslc already cleared the bar first — worth a look in a future tick.) |
| the-schedule-kept-changing-as-much-as-the-cast | single | 2026-08-07 | 2026-08-07 | new list 2026-08-07 (content-curator tick, twenty-ninth Rule-3 pass, same zero-`category: single`-show census as the four-names-never-leave-the-credits pass — this tick worked the census's #1 priority fallback, rhod (5 seasons), since rhoslc had already been claimed. Read all 5 rhod season files plus `content/shows/rhod/canon.md` directly. Duplication check: `grep -rl "show: rhod$" content/themes/*.md` returned exactly the five files named in the brief — `tried-once-never-repeated` (S03, zero-cast-turnover fact), `the-slow-build-was-the-point` (S04, new-arrival/slow-build-to-reunion fact), `the-couch-kept-adding-chairs` (S02, founding-four-to-six expansion fact), `new-flags-planted-fast` (S01, debut/church-committees/first-Texas-shoot fact), `closing-statement` (S05, billed-goodbye/off-camera-clip-controversy fact) — read all five entries in full and confirmed this list's angle (premiere-date drift, episode-order arithmetic, and roster-continuity facts distinct from cast-size or reunion-controversy claims) doesn't restate any of them. 11 entries, 1 show (single-show list, no cross-canon floor): S01 — Tiffany Hendra's one-season-only run + the show's shortest (11-ep) order; S02 — the April→August premiere-date shift held through S03 + the 11→14 episode-order growth; S03 — Cary Deuber's final full-time season landing a year ahead of S04's shakeup (distinct from the zero-turnover fact already staked at `tried-once-never-repeated`) + the 18-episode order (longest, tied only by S05); S04 — LeeAnne Locken's final season + the only RHOD season to premiere in one calendar year (Sept 2019) and close in the next (Jan 2020); S05 — Jennifer Davis Long's friend-of-the-show role, RHOD's first use of that reduced status + the 18-episode tie with S03 + Kary Brittingham (S04's lone addition) carrying over as the only S04 newcomer still in the main cast when S05's own newcomers arrive. `related` points to `four-names-never-leave-the-credits` and `the-founding-five-kept-getting-replaced` (both single-show Housewives roster-structure lists, confirmed via grep that both are genuinely sibling-pattern, not same-show). |
| the-sequel-season-has-to-clear-its-own-bar | single | 2026-08-07 | 2026-08-07 | new list 2026-08-07 (content-curator tick, thirty-first Rule-3 pass, season-number cross-reference method: ran a full `show: the-challenge` grep across every `content/themes/*.md` for the 12 candidate seasons where MTV reran a prior season's own format as an explicit sequel — S09/S10/S11/S14/S15/S18/S19/S23/S24/S26/S28/S34 — and confirmed none of the 176 pre-existing theme files stakes the "sequel judged against its original" fact for any of them; each was claimed elsewhere, if at all, by an unrelated fact (host changes, location, scheduling). 12 entries, 1 show (single-show list, no cross-canon floor). Grounded entirely in each season's own `lede`/`pull` text, ranked from clearest-earned sequel to weakest repeat: S10 Inferno II ("the format finally caught up to its cast") and S11 Gauntlet 2 (TJ Lavin's debut, "the franchise's modern register starts here") anchor the top as sequels that surpassed or redefined their originals; S09 Battle of the Sexes 2 and S18 Duel II follow as sequels that cleared the bar; S24 Rivals II and S19 Fresh Meat II sit in the confident-but-not-groundbreaking middle (the latter's own text leaves its premise "not quite settled"); S15 Gauntlet III and S26 Exes II read as competent, backward-looking repeats; S34 War of the Worlds 2, S14 Inferno 3, S28 Rivals III, and S23 Battle of the Seasons (2012) close the list as sequels whose own text concedes diminishing returns ("iteration rather than discovery," "the surprise already spent," "the weaker take on a strong concept"). `related` points to `best-challenge-design` and `best-comeback-seasons`, the two existing multi-show lists carrying the most the-challenge entries. |
| the-return-trip-built-into-the-format | single | 2026-08-07 | 2026-08-07 | new list 2026-08-07 (content-curator tick, thirty-fifth Rule-3 pass; Rule-2 season-fill gap table fully starred/unaired, zero lists 90-day review-due — fell through to Rule 3. Picked up the unresolved lead from the twenty-eighth pass's zero-`category: single` census, worked in priority order: rhod (best stake ratio, 6 stakes/5 seasons) read in full first — rejected. `the-schedule-kept-changing-as-much-as-the-cast` alone already stakes 9 rhod entries across cast-addition/exit/unchanged-cast facts for all 5 seasons, plus `the-couch-kept-adding-chairs` (S02 expansion), `tried-once-never-repeated` (S03 zero-turnover), `closing-statement` (S05 billed-final), `new-flags-planted-fast` (S01 debut), and `the-slow-build-was-the-point` (S04 reunion build) restate the identical cast-configuration throughline — no angle clears the distinct-angle gate. below-deck-down-under checked next (7 stakes/4 seasons) — also rejected: `a-change-of-address` already stakes the exact geographic-drift angle for S03/S04 (leaving Australian waters, then the Caribbean), `best-location-reveals` + `new-flags-planted-fast` cover S01/S02's location facts, and `the-paycheck-writes-the-plot` + `familiar-faces-wrong-franchise` cover the remaining crew/crossover angles — all 4 seasons' natural facts already claimed. alone-australia checked next (7 stakes/3 seasons) — rejected as both thin (3 seasons) and exhaustively mined: `the-place-fought-back` (weather/terrain, all 3 seasons), `one-rule-never-bends` (format-travel rule, all 3 seasons), `best-location-reveals` + `when-the-crew-stepped-into-frame` + `new-flags-planted-fast` + `the-blackout-had-a-loophole` (S01/S02 founding + international-move facts), `running-on-muscle-memory` (S03 consolidation) — no unclaimed angle for a 3-entry floor. Fell to the-ultimatum's flagged "swap" angle: read all 4 season files' `watch_list` blocks directly and confirmed the mid-season "trial pairs rotate back to original partner" beat appears in every season's watch_list but is never staked as the primary fact anywhere in the ledger (`grep -rl "show: the-ultimatum$" content/themes/*.md` returns exactly 7 files — `best-premieres`/`missing-on-purpose`/`the-hand-behind-the-couple`/`built-for-the-drop` on S01, `proving-the-debut-wasnt-luck` on S02, `running-on-muscle-memory` on S03, `season-one-doesnt-own-every-first` on S04 — none stake the swap). 4 entries, 1 show (single-show list, no cross-canon floor, one per season per the brief's own-per-season allowance given the thin 4-season catalog). Each entry grounds the swap in a genuinely distinct circumstance pulled from the season's own lede/pull rather than restating "the swap happened again": S01 frames it as the format's unproven founding bet; S02 as a cast now strategizing around a mechanic they watched happen the year before; S03 as a routine the show no longer explains, resting on cast history instead of novelty; S04 as a comparison that lands differently because the Las Vegas cast's original partner and home life were never a relocated set to begin with. `related` points to `a-dating-experiment-still-writing-its-own-rulebook` (Love Is Blind, same fixed-premise/shifting-mechanics single-show pattern) and `the-reshuffle-stays-in-house` (MAFS Australia, same pairing-mechanic-evolution single-show pattern). |
| the-blueprint-gets-rewritten-every-winter | single | 2026-08-09 | 2026-08-09 | new list 2026-08-09 (cloud content-gap tick, Rule 3 — Rule 2 had zero actionable picks this tick, all remaining CADENCE gap rows starred/confirmed-but-unaired per the fifth full sweep earlier today). Traitors (US) four-entry deep-cut tracking how the cast makeup, release cadence, and protection mechanic each get rebuilt at least once across the show's four winters: S02 ranked 1 (three structural changes land at once — all-celebrity cast, three-then-weekly drop, protection moves into the missions), S01 ranked 2 (the only mixed-cast season and the only season with the Armory), S03 ranked 3 (the only season to add players mid-run), S04 ranked 4 (the first season to add nothing new). Grounded entirely in each season's own frontmatter/body text; no prior ledger appearance staked the format-rebuild-cadence fact for any of the four seasons. |
| the-pitch-names-where-the-idea-came-from | craft | 2026-08-08 | 2026-08-21 | **re-checked 2026-08-15** (content-curator tick, extend-the-list task): ran an exhaustive re-search well beyond the founding pass's two sweeps — ~20 distinct grep patterns across every `content/shows/**/seasons/*.md` file, covering `borrow(ed)?|credited|named after|inspired by|modeled after|homage|nod to|riff on|steals? from|imported from|in the mold of|echoes of|lifted from|takes a page from|copies|copycat`, `[A-Z][a-zA-Z']+-style`, `playbook|channels|a page from|debuted on|first used on|popularized by|made famous by`, `a version of|a spin on|plays like|reads like|à la|in the style of|essentially a|its own take on|a riff on|the same premise as|the same idea as|the same trick|the same twist as|swipes|ripped from|straight out of`, `the UK original|the British original|adapted from|based on the .* format|import(s|ed)? the|the Dutch|originated on`, `cribs|lifts (the|a)|swipes (the|a)|mimics|apes the|mirrors the format|a trick borrowed|a twist borrowed|a mechanic borrowed|a concept borrowed|first tried on|already proven on`, plus direct-name greps for every franchise in the catalog (Big Brother, Survivor, Love Island, Traitors, Drag Race, Amazing Race, Top Chef, MasterChef, The Voice, American Idol, Project Runway, Housewives, Masked Singer, Hell's Kitchen, Shark Tank, Jersey Shore, Southern Charm, Summer House, Selling Sunset, Love Is Blind, The Apprentice, Bake Off, Got Talent, Squid Game, Naked and Afraid/Alone cross-check). Every hit resolved to one of three already-excluded classes: (1) in-franchise/spinoff self-reference — Survivor Guatemala's "borrowing back from later seasons," Big Brother S13's "the move every later returnee season is borrowed from," Top Chef California/DC referencing Top Chef Texas, Real World S31's Challenge/Road Rules missions (already staked at `the-franchise-started-borrowing-from-itself` rank 10), Vanderpump Rules S01 as an explicit RHOBH spinoff; (2) casting/personnel crossovers rather than a mechanic borrow — Amazing Race S31/S38 (Big Brother/Survivor alumni fields), The Challenge S41 (Survivor/Big Brother/Love Island alumni pool), Perfect Match S02/S03 (Love Is Blind/Too Hot to Handle/Squid Game: The Challenge/The Mole cast pool, already the province of `familiar-faces-wrong-franchise`), Below Deck Down Under S04 (RHOSLC guest crossover), Top Chef Carolinas (Southern Charm guest-judge cameo); (3) same-IP territorial license rather than a different production — Big Brother S01's eviction model "lifted from the European original," Dancing with the Stars S01 "imported the BBC blueprint," MasterChef Australia adapting the UK original, Traitors S02 "stopped trailing the UK original" — all already the founding note's own exclusion class. No new entry clears the actual bar (a season's own copy naming a genuinely different production's mechanic, the way the existing three do). List holds at 3 entries, 3 shows — no change, no padding. `last_revised` untouched (no real content change per this file's own header rule); `last_reviewed` bumped only. — new list 2026-08-08 (content-curator tick, cross-franchise-mechanic-borrowing lead picked up from the forty-third pass's unfinished note. That pass had confirmed two explicit, ledger-unclaimed cross-franchise borrow facts — Bachelor in Paradise S08 (`pull`/`lede`/`format_summary` all explicitly credit the Casa Amor-style gender-split twist to Love Island UK) and The Challenge S16 "The Island" (`eyebrow`/`lede` frame it outright as a "Survivor-style experiment") — but stalled one show short of the ≥3-distinct-show craft-category floor. This pass found the third independently: American Ninja Warrior S01 "The Proving Ground" — its own `lede`/`pull`/`format_caption`/body all state the debut season existed purely as a qualifying tryout to send Americans to compete on Mount Midoriyama, "the legendary course from Japan's Sasuke" ("a companion piece to Japan's Sasuke, not yet its own standalone competition"). Confirmed via full re-grep of `[A-Z][a-zA-Z']+-style` and `borrow|adapt|homage|nod to|riff|imported|steals? from` across every `content/shows/**/*.md` file that no stronger fourth candidate exists: every other hit was either in-franchise (Real World S31's Challenge/Road Rules missions, already staked at `the-franchise-started-borrowing-from-itself`; The Challenge's own recurring "Gauntlet-style" callbacks; Top Chef Texas's regional-travel idea "borrowed back" every era since), a same-franchise territorial adaptation (Love Island US S04 crossing over Love Island UK's narrator; Big Brother S01's eviction model "lifted from the European original"; MasterChef Australia S01 "adapting an international format" from the UK original; Traitors US borrowing from the Dutch/UK original) — all excluded as licensed-remake-of-the-same-IP rather than a genuinely different production borrowing a genuinely different show's mechanic — or a casting/personnel crossover already staked at `familiar-faces-wrong-franchise` (Perfect Match's Love Is Blind/Too Hot to Handle/Squid Game: The Challenge/The Mole cast pool), not a format/mechanic borrow. Also checked and rejected as too vague to ground without inventing a connection the source text doesn't state: Drag Race All Stars S3's "jury-style finale" (a real-world echo of Survivor's jury, but the season's own copy never names Survivor). 3 entries, 3 shows (american-ninja-warrior, bachelor-in-paradise, the-challenge) — exactly clears the craft-category ≥3-distinct-show floor. Shipped as a deliberately tight, three-entry list rather than padded to 10: the angle requires the season's *own* copy to name a different, real production by name, which is a genuinely rare and specific bar, and after two independent exhaustive passes (forty-third + this one) across every season file in the catalog, three is what's actually there. `status: started` signals room to grow if a future pass finds a fourth. `related` points to `the-franchise-started-borrowing-from-itself` (the sibling in-franchise-borrowing list this one was carved out from) and `familiar-faces-wrong-franchise` (the sibling personnel-crossover list, same "wrong franchise" family, different axis — mechanic vs. cast). Secondary lead surfaced but NOT shipped this tick: while chasing this angle, found one new well-grounded candidate to extend `the-vote-left-the-phone-line` (era, 8 entries, sub-10 floor) — So You Think You Can Dance S08's own `pull`/watch_list explicitly states it as "the show's first text-and-online voting" (distinct from the already-staked S11 full phone-elimination fact). Checked American Idol (all 23 other season files), Dancing with the Stars (canon + all season files), The Voice (6 files), and America's Got Talent (19 season files) for comparable vote-channel-transition facts explicitly stated in-text — found none beyond what's already staked at S01/S10/S16/S24 (Idol), S01/S31 (DWTS), and S20 (AGT). One new entry alone falls short of the 3–5 target for a worthwhile extension tick; flagging SYTYCD S08 here so a future pass can pair it with 2–4 more once found, rather than re-deriving this same search. — **re-checked 2026-08-21** (cloud march tick, content-curator direct invocation, extend-first candidate #1 named in the tick's brief): re-read this row's full history plus the 2026-08-20 fourth-same-day-pass re-confirmation (which independently re-ran the brief's own suggested grep pattern and reproduced the identical five already-excluded hits) before starting. Rule 2 re-confirmed stalled (`plan/CADENCE.md` fully starred) and no ledger row past the 90-day review floor. Declined to re-run the identical ~20-pattern sweep a third time in eight days — no new season file has been filed anywhere in the catalog since the 2026-08-15 exhaustive search (Rule 2 has shipped zero new seasons in that window), so an identical search over an identical corpus would reproduce the identical three-entry result; re-deriving it again would burn the tick's search budget without a chance of new ground, contrary to the standing "don't re-walk an already-logged dead end" instruction. Spent the budget instead on two adjacent, not-previously-logged angles: (1) a dual-network/simulcast "distribution-platform" structural-first thesis, developed independently via fresh `simulcast|day-and-date|premiere event` greps across every season file — surfaced five shows (rhom, married-at-first-sight, dragrace-uk, dancing-with-the-stars, american-ninja-warrior) that looked like fresh cross-canon ground, but a `grep -rl "show: <slug>$" content/themes/*.md` sweep on all five found the exact thesis already shipped and comprehensively mined at `two-channels-same-night` (craft, 12 entries/6 shows, `last_revised: 2026-08-01`) — every single one of the five seasons found by the fresh grep is already an entry there. Checked one possible extension lead within that list (Dancing with the Stars S31, the Disney+-exclusive season immediately preceding S32's dual-platform return, a natural "before" bookend matching the shape of the list's existing below-deck-down-under S01 bookend) — found it already staked three times over (`moving-day`, `the-doubters-had-to-walk-it-back` rank 9, `the-vote-left-the-phone-line` rank 1), all three on the identical streaming-move fact; a fourth stake would restate rather than add a genuinely new facet, so left unadded. (2) A "farewell season that turned out not to be final" / cancellation-then-revival thesis (American Idol S15 "The Farewell" → S16 "The Network Return" as the seed case) — checked for cross-canon overlap before investing in a full search and found `the-doubters-had-to-walk-it-back` (tone, 16 entries/16 shows) already stakes American Idol S16 itself on the adjacent revival-skepticism facet, and RHOM's cancellation-to-Peacock-revival arc is already the entire spine of `the-wait-between-seasons-was-never-the-same-twice`; a new list built on the same seed material would clear well past the 40% natural-overlap dedup bar against those two already-comprehensive lists, so abandoned before a full catalog sweep. Net: no new ground on candidate #1 itself (search budget correctly not re-spent on an eight-day-old exhaustive negative), and two independently-generated new-list concepts both resolved to already-saturated ground on inspection. `last_reviewed` bumped to 2026-08-21 above; `last_revised` untouched (no content change). |
| the-calendar-moved-the-format-didnt | craft | 2026-08-15 | 2026-08-21 | **re-checked 2026-08-15, second same-day pass (content-curator tick, extend-the-list task, Rule-2 season-fill confirmed stalled per `plan/CADENCE.md`'s fully-starred gap table): zero-ship, no new entries.** Read the target file, both related siblings (`the-schedule-didnt-ask-permission`, `no-season-here-got-the-calendar-to-itself`), and this row's full history in full before starting, per the brief. Ran a dozen-plus fresh grep sweeps across every `content/shows/**/seasons/*.md` beyond the two prior passes' patterns — weekday-move phrasing (`held its Wednesday`, `abandons its Friday`, `switches from a … night`), platform/distribution-move phrasing (`new time slot`, `network moved`, `moved the show`), cadence/frequency phrasing (`once-per-year`, `burn(ed)? off`, `counter-program`), and generic first-in-a-new-season phrasing (`the show's first fall`, `premiere.*pushed`, `earliest/latest premiere`). Found several near-misses, all read in full and rejected for cause: Love Island UK S06/S09 ("first winter edition") bundle the calendar move with a full location change (Mallorca→Cape Town/Franschhoek) and a new host in the same swing — the season's own `lede` frames it primarily as "the location experiment," not a calendar-only move, and both facts are already staked at `a-change-of-address` and `the-mic-changed-hands`; Project Runway S03 ("first summer-slot run," `format_changes: []`) is a clean textual match but the identical fact — first summer premiere, twice-a-year proof — is already staked verbatim at `twice-in-one-year` rank 7; Dancing with the Stars S17 ("first fall edition of the once-per-year model") is a frequency/cadence change, not a season-of-year or day-of-week slot change, and is the direct continuation of a fact `twice-in-one-year` already stakes from S16's side; Dancing with the Stars S31 ("The Streaming Move," ABC→Disney+, its own text states "the format itself stayed intact") is a distribution-platform move, a different axis from this list's calendar-slot thesis entirely; American Idol S16 (Fox→ABC revival) pairs the network move with an entirely new judging panel, too much simultaneous change; RHOP S05, Bachelorette S16, Amazing Race S32, and Love Island UK S07 are all pandemic/COVID-forced schedule shifts (the sibling list's thesis, not this one's deliberate-move thesis); Big Brother S11/S21, SYTYCD S18, Real World S02/S03, Chopped S07/S15, and Selling Sunset S06 all matched search terms but describe format twists, location relocations, or air-window compactness, not a season-of-year/day-of-week calendar move. Checked masterchef, ink-master, the-apprentice, americas-next-top-model, top-chef, dragrace/dragrace-uk, below-deck (all four spinoffs), married-at-first-sight, the-voice, americas-got-talent for any comparable schedule-slot language and found none. List holds at 6 entries / 4 shows — no change, no padding to hit the 10-entry floor with a weak fit. `last_revised` untouched (no real content change per this file's own header rule); `last_reviewed` re-bumped to confirm the re-check. — extended 2026-08-15 (content-curator tick, extend-the-list task): re-ran an exhaustive fresh search across every `content/shows/**/seasons/*.md` file — beyond the founding pass's premiere-month/night regex set, broadened to explicit month-name + "premiere"/"moved" phrasing, weekday-slot language, and "experiment"/"only season to air in" framings. Landed two new grounded, unstaked hits: Amazing Race S05 (`format_changes: [summer-slot]`, body: "The summer experiment. CBS moved the fifth outing into July... The Tuesday slot built steady summer numbers" — CBS's first deliberate move of the race into a summer window, format/route mechanics unchanged) and Hell's Kitchen S05 (body: "Season five moved to a January premiere" — the format's actual first winter slot, seasons 1-4 having all premiered May/June per their own `premiere_date` fields; a clean prequel to the already-shipped S14 entry, which explicitly reads "first winter slot since the early seasons"). Confirmed via full `show: amazing-race` and `show: hells-kitchen` greps across every `content/themes/*.md` that neither season's calendar fact was staked anywhere else — Amazing Race S05 has zero prior ledger appearances at all; Hell's Kitchen S05 also has zero. Rejected several close candidates after reading their full files: Masked Singer S07 "The Midpoint" (its own February-premiere/"testing the format outside fall" fact reads identically at `the-masks-changed-every-week-the-panel-never-did` rank 6 — "Season seven moves to a February slot to see if the format needs the fall calendar to work" — a verbatim duplicate stake, not a distinct facet); RHOA S14 "The Shake-Up" (its May-replaces-November premiere shift is already stated as a secondary fact inside two other entries — `the-anchor-count-set-the-ceiling` rank 11 and `a-guest-spot-with-room-to-grow` rank 9 — both already quote "the premiere date itself moved by six months"); RHOA S13 "The Pause" (own eyebrow reads "COVID-delayed" — the first-December-premiere fact is pandemic-forced, not the deliberate move this list requires); Amazing Race S09/S25/S30 (each moves the broadcast night, but none of the three seasons' own copy flags the move as notable/first, and S25 additionally introduces real format mechanics — the Save, Blind Detour — that break the "format ran unchanged" bar); Bachelor S11 (a single passing "franchise's first fall return to home base" clause, no dedicated `lede`/`format_caption` grounding, too thin against the bar the other four entries set); Perfect Match S02 and Love Island US S04 (both pair a real production-platform move — Panama-to-Tulum, CBS-to-Peacock daily-drop — with a genuine format-mechanic change, disqualified by the same unchanged-format requirement); Bake Off S08 and ANTM S23 (network-relaunch moves, not season-of-year/day-of-week calendar shifts). List grows 4→6 entries, still 4 distinct shows (amazing-race joins shark-tank/bachelor-in-paradise/hells-kitchen; hells-kitchen now carries 2 of 6, shark-tank 2 of 6, no show over the informal per-show cap). `status` bumped `started` → `growing`. `related` unchanged (still the two schedule-adjacent siblings this angle was carved distinct from). — fix 2026-08-14 (cloud march, CRITIQUE pass-111 MED finding — three of four entries' blurbs closed on the identical "X doesn't change; only/but Y does" rhetorical template, reading as a mad-lib. Rewrote rank 1 (shark-tank S04) and rank 3 (hells-kitchen S14) closing sentences to distinct shapes — "What shifted was the release date, not the show itself." and "Nothing else about the season changed — it just landed on a different point in the network's calendar." — leaving rank 2 (bachelor-in-paradise S08) as the sole entry keeping the formula. Rank 4 untouched (never used the template). No facts changed, only sentence shape; both blurbs restate facts already stated earlier in the same blurb. Picked up per the established ship-content/critique dispatch-starvation workaround, issue #758 — Rule 2 confirmed stalled, Rule 3 already exhausted 18x same-day.) | new list 2026-08-09 (content-curator tick, seventh same-day Rule-3 pass, Rule 2 gap table re-confirmed fully starred before falling to Rule 3; six earlier same-day passes above had already exhausted guest-roster/guest-judge, themed-weeks/format-variety, non-pandemic disruption, wardrobe/catchphrase, prize-structure, episode-runtime, category:single show-gap census, parent-child casting, medical-evacuation/safety-incident, and Amazing Race S28 hometown-start axes — worked a fresh one instead: a season's *own copy* stating it moved to an unusual broadcast slot (a new season-of-year, or a new night of the week) with nothing forcing the move, distinct from `the-schedule-didnt-ask-permission`'s external-disruption thesis (strike/investigation/injury) and from `no-season-here-got-the-calendar-to-itself`'s Chopped-only air-window-overlap thesis. Grepped `first (fall|spring|summer|winter) premiere|premieres? in .* for the first time|shifts? .* to a (fall|spring|summer|winter)|breaking from the franchise's usual|moves .* from .* to .* (night|slot)` across every `content/shows/**/seasons/*.md`. Four grounded, unstaked hits across 3 distinct shows: Shark Tank S04 (`lede`: "Shark Tank's first fall premiere," paired with the show's biggest episode order to date), Bachelor in Paradise S08 (`lede`/`filming_caption`: "first fall premiere in franchise history," breaking a run of summer-only premieres), Hell's Kitchen S14 (`lede`/`format_caption`: "the format's first winter slot since the early seasons" — season's own title is literally "Winter Premiere"), and Shark Tank S17 (`lede`: "moves Shark Tank from Friday to Wednesday nights," its own `watch_list` leading with the night change ahead of the new full-time panelist). Confirmed via full `show: hells-kitchen`, `show: shark-tank`, and `show: bachelor-in-paradise` greps across every `content/themes/*.md` that none of the four had this specific calendar-slot-change fact staked elsewhere: Shark Tank S04's only prior appearance is nowhere in the ledger (fully unstaked); Shark Tank S17's guest-chair/full-time-panelist fact is already staked at `the-extra-seat-is-never-a-swap` rank 8, a different facet of the same season; Bachelor in Paradise S08's Casa-Amor-credited-twist fact is already staked at `the-pitch-names-where-the-idea-came-from` rank 2, also a different facet; Hell's Kitchen S14 has zero prior ledger appearances at all. 4 entries, 3 shows (shark-tank appears twice, under the informal per-show cap) — clears the craft-category ≥3-distinct-show floor. Searched further for a 5th/6th entry (broadened greps for timeslot/night-of-week changes, midseason/counter-programming language) and found nothing more catalog-wide; shipped at 4 entries with `status: started` rather than force a weak fifth. `related` points to the two schedule-adjacent siblings this angle was carved distinct from. **Re-checked 2026-08-21 (content-curator direct invocation, dispatched to this list as the fallback target after `one-season-two-flags` re-confirmed dead the same tick): zero-ship, one genuine near-miss found and rejected for cause.** So You Think You Can Dance S06 "The Fall Season" reads promising on first pass — its own `lede` states "the only season in the franchise's run to air in the fall, season six premieres in September instead of May... a scheduling experiment the show never repeats," matching this list's deliberate-move-nothing-forced framing on its face, and neither the founding 2026-08-09 pass nor the 2026-08-15 re-checks explicitly name-checked this show in their swept-and-cleared list. Read the full season file before drafting: the same file's own `pull` and body go on to state the move caused real in-season disruption — "World Series scheduling bumps the first two results episodes off the air entirely," a genuine forced schedule collision, not a clean unaffected run. That fact is already staked, near-verbatim, at the sibling list `the-schedule-didnt-ask-permission` rank 6 ("A World Series scheduling collision and a late illness withdrawal test a broadcast experiment"), whose thesis is explicitly the opposite of this list's ("the outside world got a vote in how the format ran"). Staking the same season's same fall-premiere fact here — even framed around the initial network decision rather than the resulting collision — would read as a soft duplicate of an already-claimed stake on a `related`-linked sibling list, and the season's own text undercuts this list's "format underneath ran exactly as designed" requirement by documenting a real broadcast disruption inside the season it moved into. Passed. No other unswept ground turned up beyond the exhaustive 2026-08-15 double-pass (re-confirmed its full checked-show list independently: masterchef, ink-master, the-apprentice, americas-next-top-model, top-chef, dragrace/dragrace-uk, below-deck x4, married-at-first-sight, the-voice, americas-got-talent, plus selling-sunset S05 — a false-positive "for the first time" hit on a reunion-format addition, not a calendar move). List holds at 6 entries / 4 shows. No `content/themes/*.md` file touched this pass; `last_revised` unchanged; `last_reviewed` re-confirmed 2026-08-21. |
...
- **ninth 2026-08-06 pass (content-curator tick): extended
  `when-the-crew-stepped-into-frame`.** Re-confirmed
  ...
  the review batch is empty (oldest `last_reviewed` still
  `survivor-pillars` at 2026-07-31, well inside the 90-day window).
  Re-confirmed the below-floor census unchanged
  (`one-season-two-flags` 9/9 structure, `the-vote-left-the-phone-line`
  8/8 era — both exhaustively dead-ended across twelve 2026-08-05
  passes plus today's earlier re-checks); declined to re-walk that
  ground per the brief's own instruction. Skipped re-verifying the
  three lists extended earlier today (`best-premieres`,
  `best-challenge-design`, `best-returnees`) per the brief's own
  steer that they're likely saturated for the day — spent the tick
  on fresh ground instead.

  Read `best-comeback-seasons`' own 2026-08-05 extend note in full
  (ledger row, `plan/LISTS.md`) since it flags a specific live lead:
  "Love Island US S08's vetting-failure-repeats fact is clean,
  well-grounded, but only one groundable show ... and its natural
  single-show-adjacent home, `when-the-crew-stepped-into-frame`, was
  already touched earlier today" (that "earlier today" was
  2026-08-05, not this tick). Re-read Love Island US S08's own season
  file (`content/shows/love-island-us/seasons/08-fiji-2026.md`)
  directly rather than trusting the prior note's paraphrase: the
  body text states plainly the season "repeats a pattern from the
  one before it: two islanders are removed over resurfaced posts,
  echoing last summer's own casting stumble," and the Ep 19
  watch_list entry frames it as "the same story that shadowed the
  season before this one, now playing out again in real time and on
  record." This is a *recurrence* claim — the same failure hitting a
  second consecutive summer — genuinely distinct from S07's existing
  entry on `when-the-crew-stepped-into-frame` (rank 7), which stakes
  only the single-instance failure. Ran a full `show: love-island-us`
  grep across every `content/themes/*.md` before drafting: S08's five
  other ledger appearances (`the-cast-outgrew-the-format` rank 5,
  cast-size; `it-took-five-seasons-to-find-a-home` rank 8,
  format-stability-at-scale; `a-way-back-in` rank 9,
  vote-reversal-mechanic; `never-starts-cold` rank 3, premiere-heat;
  `live-without-a-net` rank 11, Casa Amor live-feed) all stake facts
  distinct from the recurring-vetting-failure claim. Shipped as rank
  8, directly below the S07 entry (existing ranks 8-10 shifted to
  9-11) — see the ledger row above for the full grounding and
  rejected-candidate trail. `when-the-crew-stepped-into-frame` grew
  10→11 entries, shows unchanged at 9 (love-island-us now 2/11, still
  well under the informal per-show cap). `last_revised` bumped (real
  content change). This resolves the specific lead
  `best-comeback-seasons`' 2026-08-05 note flagged as blocked-not-
  dead — a future pass does not need to re-derive it.

- **tenth 2026-08-06 pass (content-curator tick): extended
  `not-who-they-say-they-are`.** Re-confirmed `plan/CADENCE.md`'s
  gap table still fully starred (next sweep due 2026-08-09) — Rule
  2 stalled, fell through to Rule 3. Re-confirmed the review batch
  is empty (oldest `last_reviewed` still `survivor-pillars` at
  2026-07-31, well inside the 90-day window). Re-confirmed the
  below-floor census unchanged (`one-season-two-flags` 9/9
  structure, `the-vote-left-the-phone-line` 8/8 era — both
  exhaustively dead-ended across twelve 2026-08-05 passes plus
  today's nine earlier re-checks); declined to re-walk that ground
  per the brief's own instruction. Skipped re-touching the four
  lists already extended earlier today (`best-premieres`,
  `best-challenge-design`, `best-returnees`,
  `when-the-crew-stepped-into-frame`) per the standing steer that
  same-day-touched lists are likely saturated for the day.

  Read `not-who-they-say-they-are`'s own 2026-07-30 extend note in
  full first (ledger row above) to inherit its already-logged
  rejections (Big Brother S08 "staked 3x elsewhere," Big Brother
  S05 "Project DNA" twin-swap already staked twice, Traitors UK
  S03/S04 and Traitors US S04 off-thesis). Independently re-derived
  and confirmed two of those from scratch before trusting the prior
  note: grepped `America's Player` and `Project DNA` across every
  `content/themes/*.md` and found the same prior stakes (three and
  four respectively), including one — `every-summer-gets-its-own-
  twist` rank 18's Big Brother S08 entry, title "One houseguest
  quietly works for an audience the rest of the house can't see" —
  that would have been a near-verbatim duplicate of the concealment
  angle this list needs. Also chased and rejected The Circle S04
  "Celebrity Catfish Season": its own season file states the
  celebrity-catfish economics ("play invented personas purely to
  grow the pot, not to compete for the win themselves") but never
  states outright that the rest of the cast doesn't know they're
  celebrities — that fact is already staked at `same-crown-new-
  price-tag` rank 7 under the economic framing, and stretching the
  file's text to cover the concealment angle would be inference,
  not grounding. Declined. Also read The Circle S02 "Joker Twist,"
  S05 "Circle Singles," and S07 "Disrupter Mode" in full — each
  layers a new secret-role mechanic onto the format's founding
  concealment premise, but none reads as a materially fresh angle
  next to the three Circle seasons already on this list, and Circle
  already sits at an informal 3-entry cap here.

  Landed on Big Brother S18 "Vets And Newbies Reprise": its own
  season file states "the Roadkill twist gives the week a secret
  third nominator the house has to identify" — a hidden power-role
  the house must actively deduce, distinct in kind from S06's
  hidden-relationships fact already on this list and structurally
  closer to the Traitor/Joker/Superinfluencer secret-role entries
  that anchor the list's thesis. Confirmed via a full-catalog
  `show: big-brother` + `season: 18` grep that the season had
  exactly one prior stake (`every-summer-gets-its-own-twist` rank
  18), and that entry's own text — "undoing whatever plan the Head
  of Household just built" — never mentions the secrecy/deduction
  angle this new entry stakes, so the two read as genuinely
  different facts about the same twist rather than a restake.
  Shipped as rank 13 (list's new bottom slot — a single hidden
  power-role embedded in one otherwise ordinary season reads as
  narrower in scope than the full-cast concealment formats ranked
  above it). `not-who-they-say-they-are` grew 12→13 entries, shows
  unchanged at 5 (big-brother now 2/13). `last_revised` bumped
  (real content change). See the ledger row above for the full
  grounding and rejected-candidate trail.

- **eleventh 2026-08-06 pass (content-curator tick): extended
  `milestones-spent-not-marked`.** Re-confirmed `plan/CADENCE.md`'s
  gap table still fully starred (next sweep due 2026-08-09) — Rule 2
  stalled, fell through to Rule 3. Re-confirmed the review batch is
  empty (oldest `last_reviewed` still `survivor-pillars` at
  2026-07-31). Skipped re-touching the seven lists already extended
  earlier today per the brief's own skip-list
  (`best-premieres`, `best-challenge-design`, `best-returnees`,
  `when-the-crew-stepped-into-frame`, `not-who-they-say-they-are`,
  `best-location-reveals`, `away-from-home-turf`).

  Surveyed the ledger for a healthy, untouched-today list with real
  headroom rather than re-walking the two exhaustively-dead-ended
  below-floor rows (`one-season-two-flags` 9/9, `the-vote-left-the-
  phone-line` 8/8). Landed on `milestones-spent-not-marked` (craft,
  22 entries, `last_revised` 2026-07-29, well under its 24-30-entry
  cap). Ran a catalog-wide `nniversary|milestone` grep across every
  `content/shows/**/seasons/*.md` to surface untapped round-number
  occasion seasons rather than guessing — this list's own thesis
  (does the round-number season genuinely rebuild the format around
  the occasion, or just decorate it) requires the season's own file
  to explicitly frame the number as a marketed anniversary/milestone.

  Landed on The Challenge S30 "XXX: Dirty 30": its own eyebrow/lede/
  pull state outright it's "the franchise's milestone season," a
  "30th-season returnees event" running "multiple structural twists
  across the run — ambushes, a redemption-house elimination track,
  the longest cast list the franchise had assembled," with the body
  confirming "the architecture is the most layered the franchise had
  attempted to date." Ran a full `show: the-challenge` + `season: 30`
  grep across every `content/themes/*.md` first: the season had three
  prior stakes (`best-reunion-specials` rank 3, staking the *reunion
  hour's* own anniversary-marking; `the-elimination-round-never-keeps-
  its-name` rank 11, staking the *title/naming convention's*
  structural-branding load; `best-post-merge` rank 7, staking the
  *endgame-compression* fact) — read all three in full and confirmed
  none pre-empts the season-wide occasion-rebuilds-the-format claim
  this list needs. Shipped at rank 6 (existing ranks 6-22 shifted to
  7-23), directly below the Top Chef S20 World All-Stars entry —
  comparable weight to the list's existing top-tier entries. List grew
  22→23 entries, shows unchanged (the-challenge now 2/23, alongside
  its existing S40 Battle of the Eras entry — a second, differently-
  numbered milestone occasion for the same franchise, matching the
  list's own AGT/Project-Runway two-entries-per-show precedent).
  `last_revised` bumped (real content change).

  Considered and rejected before landing here: Amazing Race S10/S20/
  S30 (read all three season files in full; none frames its round
  number as a marketed anniversary occasion — S20's own text reads as
  deliberately unremarkable, "the version the show had been making
  for a decade now... without reaching for novelty," too thin a
  milestone claim absent an explicit anniversary tag in the title or
  eyebrow, unlike every existing entry on this list). Also spot-
  checked two small single-show lists surfaced by the same grep
  sweep for extend-headroom before committing to milestones-spent-
  not-marked: `seven-ways-to-break-the-same-app` (The Circle, single,
  7 entries) has zero headroom — all 7 filed Circle seasons are
  already claimed on the list; `the-quiet-register-was-the-whole-
  point-until-ibiza` (Below Deck Sailing Yacht, single, 5 entries)
  likewise has zero headroom — all 5 filed seasons already claimed.
...
- 2026-08-09 fourth same-day pass (cloud march tick): re-confirmed
  ...
  adjustment.
- 2026-08-09 fifth same-day pass (content-curator tick): shipped.
  Rule 2 gap table re-confirmed fully starred before falling to
  Rule 3. Rather than re-running fresh-concept mining (four
  same-day passes above already exhausted finale/format-license/
  live-broadcast, disruption, wardrobe, prize-structure, runtime,
  single-category census, parent-child, and guest-judge/cameo axes,
  all zero-ship), ran an extend-first pass instead: read the full
  Ledger for `tone`/`structure`/`craft`/`era` lists sitting under
  the 24-entry cap with recent extend activity not already touched
  today. Landed on `best-post-merge` (structure, last touched
  2026-08-07, 13 entries across 7 shows, active extend history,
  untouched by any of today's four earlier passes). Extended
  13→14 entries, shows unchanged at 7 (top-chef's third entry,
  still under the informal 3-per-show cross-canon cap): Top Chef
  S04 "Chicago," rank 14, grounded in the season's own Ep-12
  watch_list line ("the cast's technical bench start[s] to
  compound," "the cooking the season delivers in the closing run
  is the strongest the franchise had shown to date") — a direct,
  season-specific match for the list's back-half-compression
  thesis, confirmed via a full `show: top-chef` grep to be distinct
  from S04's two other ledger appearances (a format-portability
  fact and a Restaurant-Wars-tradition fact, neither touching the
  finals run-up). Full audit trail and rejected-candidate list
  logged inline in the Ledger row above (nine other Top Chef
  road-show seasons rejected as templated watch_list boilerplate
  with no distinguishing texture; six Dancing with the Stars
  seasons rejected on the same templated-language basis). No
...
- **2026-08-09 seventh same-day pass (content-curator tick): shipped.**
  Re-confirmed Rule 2 gap table still fully starred before falling to
  Rule 3. Read the six prior same-day passes' logged dead ends first and
  skipped all of them (guest-roster/guest-judge, themed-weeks/format-
  variety, non-pandemic disruption, wardrobe/catchphrase, prize-structure,
  episode-runtime, category:single show-gap census, parent-child casting,
  medical-evacuation/safety-incident, Amazing Race S28 hometown-start).
  Worked a fresh axis: a season's own copy stating a voluntary broadcast-
  slot move (a new season-of-year premiere, or a new night of the week)
  with no external disruption cited — distinct from `the-schedule-didnt-
  ask-permission`'s strike/investigation/injury thesis and `no-season-
  here-got-the-calendar-to-itself`'s Chopped-only air-window-overlap
  thesis. Grepped `first (fall|spring|summer|winter) premiere|premieres?
  in .* for the first time|shifts? .* to a (fall|spring|summer|winter)|
  moves .* from .* to .* (night|slot)` across every season file. Landed
  four grounded, unstaked hits across 3 distinct shows — Shark Tank S04
  (first fall premiere), Bachelor in Paradise S08 (first fall premiere
  in franchise history), Hell's Kitchen S14 (first winter slot since the
  early seasons — the season's own title is literally "Winter Premiere"),
  Shark Tank S17 (Friday-to-Wednesday move, the season's own copy leading
  with the night change ahead of its new full-time panelist). Confirmed
  via full `show:` greps across every theme file that none of the four
  had this specific slot-change fact staked before (Shark Tank S17's
  guest-chair fact and Bachelor in Paradise S08's Casa-Amor-credit fact
  are each staked elsewhere for a different facet of the same season;
  Shark Tank S04 and Hell's Kitchen S14 were fully unstaked). Shipped
  `content/themes/the-calendar-moved-the-format-didnt.md`, 4 entries /
  3 shows, `category: craft`, `status: started`. Searched further
  (timeslot/night-of-week broadened greps, midseason/counter-programming
  language) for a 5th/6th entry and found nothing more catalog-wide —
  shipped tight rather than pad. Files written: `content/themes/the-
  calendar-moved-the-format-didnt.md`, `plan/LISTS.md` (this note + the
  Ledger row). Seven same-day Rule-3 passes today; two shipped (this one,
  and the fifth pass's `best-post-merge` extend), five zero-shipped on
  distinct axes — saturation is real but not total; a genuinely fresh
  axis was still findable this pass.
- **2026-08-09 eighth same-day pass (content-curator tick): shipped.**
  Re-confirmed Rule 2 gap table still fully starred (46/46, unchanged
  since the fifth sweep drained `masterchef-australia` S18 same-day)
  before falling to Rule 3. Re-checked the three known below-floor
  cross-canon lists (`the-vote-left-the-phone-line` 8/8,
  `one-season-two-flags` 9/9, `the-pitch-names-where-the-idea-came-from`
  3/3) — all re-confirmed dead-ends, no change since the sixth pass's
  re-check. Read all seven prior same-day passes' logged dead ends and
  did not re-walk any of them (parent-child pairs, guest-judge/cameo,
  medical-evacuation/safety-incident, Amazing Race S28 hometown-start,
  mid-season bombshell additions, portable power items, companion
  aftershows, non-elimination mercy twists, real-exes casting brief,
  Voice Steal/Block/Instant Save, AGT Golden Buzzer, RHO cast-wipe,
  RHONY group-trip, recurring signature-challenge ritual, non-pandemic
  disruption, wardrobe/catchphrase, prize-structure, episode-runtime,
  category:single show-gap census, voluntary broadcast-slot moves).
  Worked a fresh axis instead: seasons whose own copy stakes an
  explicit ratings/audience-record claim, checked against
  `the-season-the-audience-showed-up-all-at-once` (tone, 11 entries/9
  shows, last touched at creation 2026-07-25, re-attempted once before
  by the 2026-08-04 hundred-and-third pass and left unshipped that
  time). Re-ran that list's own grounding grep
  (`highest-rated|most-watched|record (ratings|audience)|biggest
  premiere|ratings record`) fresh across every `content/shows/**/*.md`
  rather than trusting the prior negative result verbatim, since two
  new seasons have filed since that 2026-08-04 check. Love Island US
  S08 re-confirmed dead (already spent on the identical fact at
  `never-starts-cold` rank 3, same rejection as before). Summer House
  S10 "The Overhaul Summer" is new and clean: its own `watch_list`
  stakes a fourth, distinct beat — "the season's reunion draws the
  largest same-day audience in the show's history" — beyond the two
  facts (cast-overhaul headcount, three-part reunion restructure)
  already staked elsewhere for this same season. Confirmed via a full
  `show: summer-house` grep across every `content/themes/*.md` that
  neither of S10's two existing appearances touches the audience-
  response fact. Shipped: extended `the-season-the-audience-showed-
  up-all-at-once` 11→12 entries, 9→10 shows (first summer-house entry
  on this list). No per-show cap crossed. Files written:
  `content/themes/the-season-the-audience-showed-up-all-at-once.md`
  (12th entry appended), `plan/LISTS.md` (this note + the Ledger row).
  Eight same-day Rule-3 passes today; three shipped (this one, the
  fifth pass's `best-post-merge` extend, and the seventh pass's new
  `the-calendar-moved-the-format-didnt` list) — the ratings-record
  axis, though a full re-derivation of a previously-tried angle, still
...
- **2026-08-10 fifteenth same-day pass (cloud march tick, content-curator
  ...
  season landing.
- **2026-08-10 sixteenth same-day pass (content-curator tick): shipped.**
  Re-confirmed the gap table still fully starred (Rule 2 stalled) and the
  review-due ledger still clean (oldest `last_reviewed` `survivor-pillars`
  at 2026-07-31, nowhere near the 90-day floor) before falling to Rule 3.
  Read the fourth/seventh/eighth/twelfth/thirteenth/fifteenth same-day
  passes' masterchef-australia S18 mining in full — all three of that
  season's groundable facts (on-air-auditions return, unchanged panel,
  themed-week density, guest-roster breadth) are confirmed exhausted
  across four separate passes, so did not re-chase it. Read the-challenge
  S41 "Vets & New Threats" cold instead — a season no prior same-day pass
  had named — and full-catalog-grepped `New Threats|Lock In|Stake a
  Claim|Performance Points` across every `content/themes/*.md` (zero
  hits) before checking its two existing ledger appearances
  (`familiar-faces-wrong-franchise` rank 4, cross-franchise casting-pool
  fact; `the-elimination-round-never-keeps-its-name` rank 20, mechanic-
  naming fact). Neither touches the season's third fact: its own `pull`
  states partner status "stays contested from open to close" across a
  three-phase Performance Points → Lock In → Stake a Claim system — a
  clean, unstaked, structural fit for `built-for-one-playing-as-a-team`
  (craft, sitting at 11/24 entries with active extend history, last
  touched 2026-08-02). Shipped: extended 11→12 entries, shows unchanged
  at 8 (second the-challenge entry, distinguished from S12 Fresh Meat's
  simpler at-the-start pairing bet by the multi-phase renegotiable
  structure). Files written: `content/themes/built-for-one-playing-as-a-
  team.md` (12th entry appended), `plan/LISTS.md` (this note + the
  Ledger row). Sixteen same-day Rule-3 passes across 2026-08-09/10; four
  shipped, twelve zero-shipped. Reading a fresh season's full file
  cold — rather than re-deriving new axes against the 182-list catalog
...
- **2026-08-10 twentieth same-day pass (content-curator tick): shipped.**
  Re-confirmed the Rule 2 gap table still fully starred (Rule 2 stalled)
  and the review-batch path still empty (oldest `last_reviewed` still
  `survivor-pillars` at 2026-07-31) before falling to Rule 3. Took the
  brief's suggested direction (a) and re-mined the three seasons drained
  same-day for a second stakeable fact beyond their existing single
  extend each. Below Deck Mediterranean S11 "Dubrovnik II" was the hit:
  its `host_caption` states "Captain Sandy Yawn's third season with this
  crew nucleus, back in Dubrovnik" — a command-continuity fact distinct
  from the location/new-yacht/new-chef/rebuilt-crew fact already staked
  at `been-here-before` rank 6. That fact is the exact, narrow thesis of
  `the-command-held-for-nine-seasons-then-didnt` (single, Below Deck
  Mediterranean), a list explicitly logged "maxed-out" at 10/10 aired
  seasons on 2026-08-03 (hundredth pass) — S11's premiere reopened it.
  Confirmed via a full `show: below-deck-mediterranean` grep across
  every `content/themes/*.md` that S11 had exactly one other ledger
  appearance (the `been-here-before` entry) before drafting. Shipped:
  extended 10→11 entries (new rank 9, "The authority has history with
  this crew; the room around it doesn't" — command continuity with the
  crew nucleus vs. an otherwise new room, tracking the show's own
  canon.md verdict that "the cast case is still unproven this early").
  Renumbered the two entries below it (ranks 9-10 → 10-11) and rewrote
  the list's title/description/tagline to replace the stale "nine of
  ten seasons" framing with "ten of eleven" (S11 is Sandy-led, so the
  one-exception count holds; only the total changed). Files written:
  `content/themes/the-command-held-for-nine-seasons-then-didnt.md`,
  `plan/LISTS.md` (this note + the ledger row). List is 11/11 aired
  seasons again — maxed-out until a twelfth Below Deck Mediterranean
  season lands. Twenty same-day Rule-3 passes across 2026-08-09/10; six
  shipped, fourteen zero-shipped. The move that found headroom here —
  re-reading a freshly-drained season's own frontmatter fields
  (`host_caption`, `eyebrow`, `watch_list`) for a second fact beyond
  what a single earlier-pass extend used, then checking that fact
  against every *other* ledger list touching the same show for a
  narrower or previously "maxed-out" fit, not just the broad-catalog
  axis-search this ledger's dead ends mostly come from — is the same
...
- **2026-08-13 Rule-3 pass (content-curator direct invocation):
  extend, not new.** Re-confirmed Rule 2 stalled per the gap table
  (nearest dated finale, american-ninja-warrior, still 4 days out
  from today). Read `plan/bearings.md` Rule 3 in full and the tail
  of this Ideas log before touching anything. Invented a genuinely
  fresh-feeling NEW-list candidate — "cast deliberately divided by
  gender as the season's entire structural premise" — grounded
  across four seasons read directly from their own frontmatter/body:
  The Apprentice S07 "The Celebrity Pivot" (celebrities split into
  an all-women and an all-men team), Ink Master S12 "Battle of the
  Sexes", The Challenge S06 "Battle of the Sexes", and The Challenge
  S09 "Battle of the Sexes 2". Before drafting, ran a full
  `show: ink-master` and `show: the-challenge` grep across every
  `content/themes/*.md` per this list's own established dedup
  discipline, and found the candidate failed the excellence gate's
  distinct-angle test outright: `one-rule-fills-every-seat` already
  stakes The Challenge S06 at rank 1 and Ink Master S12 at rank 3 as
  its two lead entries for exactly this "gender line decides every
  seat" thesis, and `every-season-split-the-room-differently` (a
  single-show Ink Master list) already stakes S12 again at rank 4.
  Two of four candidate entries pre-claimed by the same existing
  list is well past the ~40%-overlap threshold in bearings.md Rule 3
  excellence-gate rule 1 ("extend the existing one instead"), so
  no new list was drafted. Pivoted to the sanctioned fallback:
  extended `one-rule-fills-every-seat` itself (craft, 16→17 entries)
  with the one candidate season not already claimed by any sibling
  list under this specific fact — The Apprentice S07, whose own file
  states plainly the civilian cast is replaced entirely by fourteen
  celebrities "split by gender into an all-women team and an
  all-men team" playing for charity money rather than a job offer.
  Inserted at rank 4, directly after the list's other two
  gender-split entries, so the three gender-line examples now read
  together. Declined to also add The Challenge S09 to the same
  list: it's already staked at `the-sequel-season-has-to-clear-
  its-own-bar` rank 3 on its sequel-status fact, and adding it here
  too would give this one list a second same-franchise instance of
  the identical gender-split rule, which the list's own "one
  distinct rule per show" pattern doesn't otherwise tolerate.
  Confirmed via a full `show: the-apprentice` grep that S07's four
  other ledger appearances (`when-scripted-went-dark`,
  `the-format-answered-to-a-different-name`,
  `familiar-faces-wrong-franchise`,
  `when-the-reward-pointed-somewhere-else`) all stake different
  facts about the same season (tone, branding, crossover casting,
  reward placement) — no collision. Ledger row updated in the same
  commit; full rationale filed against the `one-rule-fills-every-
  seat` row above. This is a genuine content ship, not a zero-ship
  tick, but it closes via the extend path rather than a new ledger
  row.

- **2026-08-13, second same-day Rule-3 pass (content-curator direct
  invocation): extend, not new.** Re-confirmed Rule 2 still stalled
  and that `one-rule-fills-every-seat` had already been extended
  earlier today (immediately above), so this pass targeted a
  different list rather than re-touching it. Below-floor lists
  (`the-vote-left-the-phone-line`, `one-season-two-flags`,
  `the-pitch-names-where-the-idea-came-from`,
  `the-calendar-moved-the-format-didnt`) were all re-checked against
  their own standing dead-end notes and left alone — nothing in the
  logged history suggested new ground since the last pass. Instead
  swept the Real Housewives cast-composition angle already live at
  `the-couch-kept-adding-chairs` (craft, 16 entries/9 shows) for a
  fresh, unclaimed swing. RHOM S07 entry, rank 6 — the season's own
  file states Stephanie Shojaee joins the main cast the same season
  "Nicole Martin steps down to guest status after four seasons as a
  full-timer," with the cast size holding flat at six — a clean
  one-for-one handoff, distinct in shape from rhom's own two
  existing entries on this list (S03's post-finale contraction, S02's
  flat-number-hides-an-overhaul upheaval). Confirmed via a full
  `show: rhom` grep across every `content/themes/*.md` that S07's
  other two ledger appearances (`two-channels-same-night`,
  `the-wait-between-seasons-was-never-the-same-twice`) stake the
  release-platform-gap and premiere-gap facts, never the cast swap.
  Chased and rejected a second RHOSLC entry first — S05's "fullest
  roster yet" fact turned out to be already staked near-verbatim at
  the show's own single-show list `four-names-never-leave-the-credits`
  rank 4, too close to a duplicate — then confirmed RHOBH and RHOC
  are each off-limits for a second entry here because their own
  cast-composition stories are already the dedicated province of
  their own single-show lists (`the-friend-credit-became-the-farm-
  system`, `the-founding-five-kept-getting-replaced`). List now runs
  17 entries across 9 shows, no show over the informal 3-per-show
...
- **2026-08-15, cloud march tick (second dispatch same day): redirected
  ...
  attempted-and-failed).
- **2026-08-15, cloud march tick (later dispatch same day): redirected
  again, no new Rule-3 search attempted.** Same two blockers persist:
  ...
  above, most recently the-ultimatum/traitors take_h2 drain at
  bf8f4f2a). Redirected this tick's slot to the `take_h2` `content:check`
  warning again (pass-47 / issue #393), draining the two next-smallest-
  count offenders: below-deck-sailing-yacht (S1-S5) and rhod (S1-S5),
  both shows now fully cleared of this warning class — see
  `plan/AUDIT.md`'s standing season-fill-drain row for the matching
  progress note (warning count 865 -> 855). No ledger row changed by
  this entry itself (a Rule-3 search was deliberately not attempted
  this tick, not attempted-and-failed).
- **2026-08-15, cloud march tick (later dispatch same day): redirected
  again, no new Rule-3 search attempted.** Same two blockers persist:
  Rule 2 still stalled (CADENCE gap table unchanged, all rows starred,
  nearest dated finale american-ninja-warrior S18 still two days out at
  2026-08-17); Rule 3 confirmed saturated (issue #758's standing
  verdict, re-confirmed several times already today by the entries
  above, most recently the below-deck-sailing-yacht/rhod take_h2 drain
  at 341bf443). Redirected this tick's slot to the `take_h2`
  `content:check` warning again (pass-47 / issue #393), draining the
  two next-smallest-count offenders: jersey-shore (S1-S6) and
  too-hot-to-handle (S2-S6), both shows now fully cleared of this
  warning class — see `plan/AUDIT.md`'s standing season-fill-drain row
...
- **2026-08-21, cloud `/march` tick (content-curator direct invocation):
  zero-ship.** Re-confirmed both standing blockers first: Rule 2
  season-fill still stalled (`plan/CADENCE.md` gap table fully starred
  confirmed-but-unaired) and zero ledger rows carry a `review-due` flag
  (oldest `last_reviewed`, `survivor-pillars` at 2026-07-31, 21 days
  old, well inside the 90-day floor). Worked the brief's ranked
  extend-first candidate list in order. The nine `category: single`
  candidates (`seven-ways-to-break-the-same-app` / the-circle,
  `the-wait-between-seasons-was-never-the-same-twice` / rhom,
  `every-season-strikes-a-different-bargain-with-lana` /
  too-hot-to-handle, `the-series-the-uk-edition-finally-made-its-own` /
  dragrace-uk, `the-quiet-register-was-the-whole-point-until-ibiza` /
  below-deck-sailing-yacht, `home-seasons-waited-relocation-seasons-
  didnt` / jersey-shore, `the-return-trip-built-into-the-format` /
  the-ultimatum, `the-blueprint-gets-rewritten-every-winter` /
  traitors) were each independently re-verified against their show's
  own `seasons:` frontmatter field directly (not trusted from the
  ledger): every one carries exactly as many entries as its show has
  aired seasons — mathematically capped, no unfiled season to draw a
  new entry from under Rule 2's own stalled gap table. `survivor-
  pillars` was reviewed 2026-07-31 (21 days ago, inside the floor) and
  already holds no change against S46-S50. Of the four cross-canon
  candidates, `one-season-two-flags` (structure, 9/9) and `the-vote-
  left-the-phone-line` (era, 8/8) have been re-confirmed dead across
  dozens of passes with no new season filed since; `the-calendar-
  moved-the-format-didnt` (craft, 6/4) was exhaustively re-checked
  twice on 2026-08-15 alone. `the-pitch-names-where-the-idea-came-
  from` (craft, 3/3) — the brief's flagged top candidate — got this
  tick's real search budget: see the detailed rationale appended
  directly to that Ledger row above, which explains why re-running the
  identical ~20-pattern grep sweep a third time in eight days was
  declined (no new source material since 2026-08-15) in favor of two
  fresh, not-previously-logged angles. Both fresh angles are logged in
  full on that same Ledger row: (1) a dual-network/simulcast
  distribution-platform thesis, independently derived via fresh greps
  and found to already exist, comprehensively, as `two-channels-same-
  night` (craft, 12 entries/6 shows) — every season the fresh grep
  surfaced was already an entry there, and the one plausible extension
  lead found within it (Dancing with the Stars S31 as a "before"
  bookend) turned out already triple-staked on the identical fact
  elsewhere; (2) a farewell-season-that-wasn't-final /
  cancellation-then-revival thesis, abandoned before a full sweep once
  its seed cases (American Idol S15/S16, RHOM's Peacock revival) were
  confirmed to sit inside two already-comprehensive lists
  (`the-doubters-had-to-walk-it-back`, 16 entries/16 shows;
  `the-wait-between-seasons-was-never-the-same-twice` itself), well
  past the 40% natural-overlap dedup bar. Net: no `content/themes/*.md`
  file written this tick. Two ledger-row updates made instead —
  `the-pitch-names-where-the-idea-came-from`'s `last_reviewed` bumped
  to 2026-08-21 with the full rationale above. This is a
  diligence-backed zero-ship, consistent with the 2026-08-13 through
  2026-08-20 saturation streak (issue #758): at 212 lists, the
...
- **2026-08-21, content-curator direct invocation (`/ship-content` Rule 3
  ...
  filing a new season.
- **2026-08-21, content-curator direct invocation (`/ship-content` Rule 3
  tick, dispatched to extend `one-season-two-flags` from 9 to 10 entries,
  with `the-calendar-moved-the-format-didnt` as the named fallback):
  zero-ship on both targets, diligence logged on each row directly.**
  Confirmed the standing blockers were unchanged from the day's four
  prior passes (Rule 2 gap table fully starred, no ledger row review-due)
  before starting. Worked `one-season-two-flags` first, independently
  before reading its own ledger history, and landed on the same
  exhausted set the 2026-08-05/08-15 passes already logged — see the
  fresh note appended directly to that row above for the full swept-file
  list. Fell through to the named fallback, `the-calendar-moved-the-
  format-didnt`, and found one real near-miss the prior two 2026-08-15
  passes hadn't explicitly name-checked: So You Think You Can Dance S06
  "The Fall Season" (own `lede`: "the only season in the franchise's run
  to air in the fall... a scheduling experiment the show never
  repeats"). Rejected it after reading the full file — the same season's
  `pull`/body text documents a genuine in-season broadcast collision
  ("World Series scheduling bumps the first two results episodes off
  the air entirely"), which is already staked, near-verbatim, at the
  `related`-linked sibling list `the-schedule-didnt-ask-permission` rank
  6, whose thesis is the direct opposite of this list's (outside forces
  intervening vs. nothing forcing the move). Full rationale on that
  row above. Net: no `content/themes/*.md` file written or edited this
  tick; both target ledger rows carry a fresh, independently-derived
  2026-08-21 confirmation note and an updated `last_reviewed` date, no
  `last_revised` bump on either (no real content change). Consistent
  with the extended 2026-08-13 through 2026-08-21 saturation streak
  (issue #758).
- **2026-08-21, content-curator direct invocation (`/ship-content` Rule 3
  tick, sixth same-day pass): zero-ship.** Explicitly instructed not to
  re-attempt `one-season-two-flags` or `the-calendar-moved-the-format-
  didnt` (both already re-confirmed dead this same tick, see the two
  rows immediately above). Read the full 181-row Ledger table plus the
  Ideas-log tail before starting, then brainstormed and independently
  chased nine fresh-seeming angles, all confirmed already comprehensively
  staked once checked against the actual shipped files (not just the
  ledger's one-line flags): (1) a former contestant returning in a
  judging/hosting capacity rather than as a player — already covered in
  depth by `someone-else-held-the-chair-for-a-while` (Top Chef S18
  alumni-judge panel is the near-exact fact); (2) athletic-background as
  the whole casting brief — already shipped at `one-rule-fills-every-seat`
  (DWTS S26 "Athletes," S18 "Winter Athletes"); (3) real-family casting
  across shows (siblings, spouses, parent-child, twins) — already
  exhaustively shipped at `when-the-cast-was-already-related` (15
  entries/12 shows, reads as full); (4) mixed-alumni-source-franchise
  casting on The Traitors — already covered at `familiar-faces-wrong-
  franchise` (S01/S02/S03 all three staked, 16 entries total, near the
  informal 24-cap); (5) fixed-set relocation as a craft angle — already
  shipped in full at `a-change-of-address` (12 entries/8 shows); (6) a
  jury-of-eliminated-peers structural mechanic (Survivor, Big Brother,
  Ink Master S16) — rejected before drafting: too thin to clear the
  10-entry floor once Ink Master S16's identical jury fact (already
  staked at `one-rule-fills-every-seat` rank 11) and Survivor/Big
  Brother's founding-season jury facts (already the address of `who-
  actually-got-the-vote` rank 1/2) are excluded; (7) panel/audience
  override-vote mechanics (Instant Save, Judges' Save, Diamond Power of
  Veto) — independently re-derived, then found already rejected on
  identical grounds (5-6 entries, sub-floor) by the 2026-07-26 eighth
  pass logged above; did not re-attempt the blocked single-show The
  Voice mechanic-history angle either, since the AUDIT.md-filed
  season-numbering corruption on that show's own files (flagged
  2026-07-26, ninth pass) is still unresolved and this pass has no
  authority to touch show/season files to fix it; (8) host-handoff
  moments across formats — already shipped in full at `the-mic-changed-
  hands` (19 entries/17 shows, effectively at cap); (9) whole-cast (not
  individual) all-returnee season structure — already shipped in full
  at `best-returnees` (11 entries/9 shows, explicitly framed on the
  full-roster-returns angle, not individual comeback performance, which
  is the separate `best-comeback-seasons` list). Net: no
  `content/themes/*.md` file written or edited this tick; no ledger row
  changed (none of the nine angles had a live, non-saturated row to
  extend). Sixth consecutive same-day zero-ship pass, consistent with
  the extended 2026-08-13 through 2026-08-21 saturation streak (issue
  #758): every angle a blind grep-and-read pass over the 67-show catalog
  can still generate at 181 lists lands inside an already-shipped list's
  address. The next unlock remains either Rule 2 filing a new season, or
